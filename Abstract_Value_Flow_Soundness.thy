...
lemma flow_state_to_flow_exp: "
  (\<V>, \<C>, \<X>, \<Y> . \<Z>) \<Turnstile>\<^sub>\<sigma> \<langle>RESULT x;\<rho>;\<langle>x\<^sub>\<kappa>,e\<^sub>\<kappa>,\<rho>\<^sub>\<kappa>\<rangle> # \<kappa>\<rangle> \<Longrightarrow> \<rho> x = Some \<omega> \<Longrightarrow> (\<V>, \<C>, \<X>, \<Y> . \<Z>) \<Turnstile>\<^sub>e  e\<^sub>\<kappa>
"
...
lemma flow_over_state_to_env: "
  (\<V>, \<C>, \<X>, \<Y> . \<Z>) \<Turnstile>\<^sub>\<sigma> \<langle>RESULT x; \<rho>; \<langle>x\<^sub>\<kappa>,e\<^sub>\<kappa>,\<rho>\<^sub>\<kappa>\<rangle> # \<kappa>\<rangle> \<Longrightarrow> \<rho> x = Some \<omega> \<Longrightarrow> 
  (\<V>, \<C>, \<X>, \<Y> . \<Z>) \<Turnstile>\<^sub>\<rho> \<rho>\<^sub>\<kappa>(x\<^sub>\<kappa> \<mapsto> \<omega>)
"
...
lemma flow_over_state_to_stack: "
  (\<V>, \<C>, \<X>, \<Y> . \<Z>) \<Turnstile>\<^sub>\<sigma>  \<langle>RESULT x; \<rho>; \<langle>x\<^sub>\<kappa>,e\<^sub>\<kappa>,\<rho>\<^sub>\<kappa>\<rangle> # \<kappa>\<rangle> \<Longrightarrow> \<rho> x = Some \<omega> \<Longrightarrow> (\<V>, \<C>, \<X>, \<Y> . \<Z>) \<Turnstile>\<^sub>\<kappa>  \<V> (\<lfloor>e\<^sub>\<kappa>\<rfloor>) \<Rrightarrow> \<kappa>
"
 apply (erule accept_state.cases, auto)
 apply (erule accept_val_env.cases, auto)
 apply (drule spec)+
...
lemma flow_over_state_1: "
  (\<V>, \<C>, \<X>, \<Y> . \<Z>) \<Turnstile>\<^sub>\<sigma>  \<langle>RESULT x; \<rho>; \<langle>x\<^sub>\<kappa>,e\<^sub>\<kappa>,\<rho>\<^sub>\<kappa>\<rangle> # \<kappa>\<rangle> \<Longrightarrow> \<rho> x = Some \<omega> \<Longrightarrow> (\<V>, \<C>, \<X>, \<Y> . \<Z>) \<Turnstile>\<^sub>\<sigma>  \<langle>e\<^sub>\<kappa>; \<rho>\<^sub>\<kappa>(x\<^sub>\<kappa> \<mapsto> \<omega>); \<kappa>\<rangle>
"
...
lemma flow_state_to_flow_exp_2: "
  (\<V>, \<C>, \<X>, \<Y> . \<Z>) \<Turnstile>\<^sub>\<sigma>  \<langle>LET x = \<lparr>\<rparr> in e; \<rho>; \<kappa>\<rangle> \<Longrightarrow> (\<V>, \<C>, \<X>, \<Y> . \<Z>) \<Turnstile>\<^sub>e  e
"
 apply (erule accept_state.cases, auto)
...
lemma flow_over_state_to_env_2: "
  (\<V>, \<C>, \<X>, \<Y> . \<Z>) \<Turnstile>\<^sub>\<sigma>  \<langle>LET x = \<lparr>\<rparr> in e; \<rho>; \<kappa>\<rangle> \<Longrightarrow> (\<V>, \<C>, \<X>, \<Y> . \<Z>) \<Turnstile>\<^sub>\<rho> \<rho>(x \<mapsto> \<lbrace>\<rbrace>)
"
 apply (rule accept_value_accept_val_env.Any, auto)
     apply (erule accept_state.cases, auto)
     apply (erule accept_exp.cases, auto)
...
lemma flow_over_state_to_stack_2: "
  (\<V>, \<C>, \<X>, \<Y> . \<Z>) \<Turnstile>\<^sub>\<sigma>  \<langle>LET x = \<lparr>\<rparr> in e; \<rho>; \<kappa>\<rangle> \<Longrightarrow> (\<V>, \<C>, \<X>, \<Y> . \<Z>) \<Turnstile>\<^sub>\<kappa>  \<V> (\<lfloor>e\<rfloor>) \<Rrightarrow> \<kappa>
"
 apply (erule accept_state.cases, auto)
done

lemma flow_over_state_2: "
  (\<V>, \<C>, \<X>, \<Y> . \<Z>) \<Turnstile>\<^sub>\<sigma>  \<langle>LET x = \<lparr>\<rparr> in e; \<rho>; \<kappa>\<rangle> \<Longrightarrow> (\<V>, \<C>, \<X>, \<Y> . \<Z>) \<Turnstile>\<^sub>\<sigma>  \<langle>e; \<rho>(x \<mapsto> \<lbrace>\<rbrace>); \<kappa>\<rangle>
"
 apply (rule accept_state.Any)
...
lemma flow_over_state_to_exp_3: "
  (\<V>, \<C>, \<X>, \<Y> . \<Z>) \<Turnstile>\<^sub>\<sigma>  \<langle>LET x = Prim p in e; \<rho>; \<kappa>\<rangle> \<Longrightarrow> (\<V>, \<C>, \<X>, \<Y> . \<Z>) \<Turnstile>\<^sub>e  e
"
 apply (erule accept_state.cases, auto)  
 apply (erule accept_exp.cases, auto)
done
...
lemma flow_over_state_to_env_3: "
  (\<V>, \<C>, \<X>, \<Y> . \<Z>) \<Turnstile>\<^sub>\<sigma>  \<langle>LET x = Prim p in e; \<rho>; \<kappa>\<rangle> \<Longrightarrow> (\<V>, \<C>, \<X>, \<Y> . \<Z>) \<Turnstile>\<^sub>\<rho> \<rho>(x \<mapsto> \<lbrace>p, \<rho>\<rbrace>)
"
 apply (rule accept_value_accept_val_env.Any, auto)
     apply (erule accept_state.cases, auto)
     apply (erule accept_exp.cases, auto)
...
lemma flow_over_state_to_stack_3: "
  (\<V>, \<C>, \<X>, \<Y> . \<Z>) \<Turnstile>\<^sub>\<sigma>  \<langle>LET x = Prim p in e; \<rho>; \<kappa>\<rangle> \<Longrightarrow> (\<V>, \<C>, \<X>, \<Y> . \<Z>) \<Turnstile>\<^sub>\<kappa>  \<V> (\<lfloor>e\<rfloor>) \<Rrightarrow> \<kappa>
"
 apply (erule accept_state.cases, auto)
done

lemma flow_over_state_3: "
  (\<V>, \<C>, \<X>, \<Y> . \<Z>) \<Turnstile>\<^sub>\<sigma>  \<langle>LET x = Prim p in e; \<rho>; \<kappa>\<rangle> \<Longrightarrow>  (\<V>, \<C>, \<X>, \<Y> . \<Z>) \<Turnstile>\<^sub>\<sigma>  \<langle>e; \<rho>(x \<mapsto> \<lbrace>p, \<rho>\<rbrace>); \<kappa>\<rangle>
"
 apply (rule accept_state.Any)
...
lemma flow_state_to_flow_exp_4: "
  (\<V>, \<C>, \<X>, \<Y> . \<Z>) \<Turnstile>\<^sub>\<sigma>  \<langle>LET x = CASE x\<^sub>s LEFT x\<^sub>l |> e\<^sub>l RIGHT x\<^sub>r |> e\<^sub>r in e; \<rho>; \<kappa>\<rangle> \<Longrightarrow> 
  \<rho> x\<^sub>s = Some \<lbrace>prim.Left x\<^sub>l', \<rho>\<^sub>l\<rbrace> \<Longrightarrow> 
  \<rho>\<^sub>l x\<^sub>l' = Some \<omega>\<^sub>l \<Longrightarrow> (\<V>, \<C>, \<X>, \<Y> . \<Z>) \<Turnstile>\<^sub>e  e\<^sub>l
"
 apply (erule accept_state.cases, auto)
 apply (erule accept_exp.cases, auto)
 apply (erule accept_val_env.cases, auto)
...
lemma flow_state_to_flow_env_4: "
  ...
  (\<V>, \<C>, \<X>, \<Y> . \<Z>) \<Turnstile>\<^sub>\<rho> \<rho>(x\<^sub>l \<mapsto> \<omega>\<^sub>l)
"
 apply (rule accept_value_accept_val_env.Any, auto)
      apply (erule accept_state.cases, auto)
      apply (erule accept_val_env.cases, auto)
...
lemma flow_state_to_flow_stack_4: "
  (\<V>, \<C>, \<X>, \<Y> . \<Z>) \<Turnstile>\<^sub>\<sigma>  \<langle>LET x = CASE x\<^sub>s LEFT x\<^sub>l |> e\<^sub>l RIGHT x\<^sub>r |> e\<^sub>r in e; \<rho>; \<kappa>\<rangle> \<Longrightarrow>
  \<rho> x\<^sub>s = Some \<lbrace>prim.Left x\<^sub>l', \<rho>\<^sub>l\<rbrace> \<Longrightarrow> \<rho>\<^sub>l x\<^sub>l' = Some \<omega>\<^sub>l \<Longrightarrow> 
  (\<V>, \<C>, \<X>, \<Y> . \<Z>) \<Turnstile>\<^sub>\<kappa> \<V> (\<lfloor>e\<^sub>l\<rfloor>) \<Rrightarrow> \<langle>x,e,\<rho>\<rangle> # \<kappa>
"
...
lemma flow_over_state_4: "
  (\<V>, \<C>, \<X>, \<Y> . \<Z>) \<Turnstile>\<^sub>\<sigma>  \<langle>LET x = CASE x\<^sub>s LEFT x\<^sub>l |> e\<^sub>l RIGHT x\<^sub>r |> e\<^sub>r in e; \<rho>; \<kappa>\<rangle> \<Longrightarrow> 
  \<rho> x\<^sub>s = Some \<lbrace>prim.Left x\<^sub>l', \<rho>\<^sub>l\<rbrace> \<Longrightarrow> 
  \<rho>\<^sub>l x\<^sub>l' = Some \<omega>\<^sub>l \<Longrightarrow> (\<V>, \<C>, \<X>, \<Y> . \<Z>) \<Turnstile>\<^sub>\<sigma>  \<langle>e\<^sub>l; \<rho>(x\<^sub>l \<mapsto> \<omega>\<^sub>l); \<langle>x,e,\<rho>\<rangle> # \<kappa>\<rangle>
"
 apply (rule accept_state.Any)
...
lemma flow_state_to_flow_exp_5: "
  ...
  \<rho>\<^sub>r x\<^sub>r' = Some \<omega>\<^sub>r \<Longrightarrow> (\<V>, \<C>, \<X>, \<Y> . \<Z>) \<Turnstile>\<^sub>e  e\<^sub>r
"
 apply (erule accept_state.cases, auto)
 apply (erule accept_exp.cases, auto)
 apply (erule accept_val_env.cases, auto)
...
lemma flow_state_to_flow_env_5: "
  ...
  (\<V>, \<C>, \<X>, \<Y> . \<Z>) \<Turnstile>\<^sub>\<rho> \<rho>(x\<^sub>r \<mapsto> \<omega>\<^sub>r)
"
 apply (rule accept_value_accept_val_env.Any, auto)
      apply (erule accept_state.cases, auto)
      apply (erule accept_val_env.cases, auto)
...
lemma flow_state_to_flow_stack_5: "
  (\<V>, \<C>, \<X>, \<Y> . \<Z>) \<Turnstile>\<^sub>\<sigma>  \<langle>LET x = CASE x\<^sub>s LEFT x\<^sub>l |> e\<^sub>l RIGHT x\<^sub>r |> e\<^sub>r in e; \<rho>; \<kappa>\<rangle> \<Longrightarrow>
  \<rho> x\<^sub>s = Some \<lbrace>prim.Right x\<^sub>r', \<rho>\<^sub>r\<rbrace> \<Longrightarrow> \<rho>\<^sub>r x\<^sub>r' = Some \<omega>\<^sub>r \<Longrightarrow> 
  (\<V>, \<C>, \<X>, \<Y> . \<Z>) \<Turnstile>\<^sub>\<kappa>  \<V> (\<lfloor>e\<^sub>r\<rfloor>) \<Rrightarrow> \<langle>x,e,\<rho>\<rangle> # \<kappa>
"
 apply (rule accept_stack.Nonempty)
    apply (erule accept_state.cases, auto, rename_tac \<omega>)
    apply (erule accept_val_env.cases, auto)
...
lemma flow_over_state_5: "
  (\<V>, \<C>, \<X>, \<Y> . \<Z>) \<Turnstile>\<^sub>\<sigma>  \<langle>LET x = CASE x\<^sub>s LEFT x\<^sub>l |> e\<^sub>l RIGHT x\<^sub>r |> e\<^sub>r in e; \<rho>; \<kappa>\<rangle> \<Longrightarrow> 
  \<rho> x\<^sub>s = Some \<lbrace>prim.Right x\<^sub>r', \<rho>\<^sub>r\<rbrace> \<Longrightarrow> 
  \<rho>\<^sub>r x\<^sub>r' = Some \<omega>\<^sub>r \<Longrightarrow> (\<V>, \<C>, \<X>, \<Y> . \<Z>) \<Turnstile>\<^sub>\<sigma>  \<langle>e\<^sub>r; \<rho>(x\<^sub>r \<mapsto> \<omega>\<^sub>r); \<langle>x,e,\<rho>\<rangle> # \<kappa>\<rangle>
"
 apply (rule accept_state.Any)
...
lemma flow_state_to_flow_exp_6: "
  (\<V>, \<C>, \<X>, \<Y> . \<Z>) \<Turnstile>\<^sub>\<sigma>  \<langle>LET x = FST x\<^sub>p in e; \<rho>; \<kappa>\<rangle> \<Longrightarrow> \<rho> x\<^sub>p = Some \<lbrace>prim.Pair x\<^sub>1 x\<^sub>2, \<rho>\<^sub>p\<rbrace> \<Longrightarrow> 
  \<rho>\<^sub>p x\<^sub>1 = Some \<omega> \<Longrightarrow> (\<V>, \<C>, \<X>, \<Y> . \<Z>) \<Turnstile>\<^sub>e  e
"
 apply (erule accept_state.cases, auto)
 apply (erule accept_exp.cases, auto)
done
...
lemma flow_state_to_flow_env_6: "
  (\<V>, \<C>, \<X>, \<Y> . \<Z>) \<Turnstile>\<^sub>\<sigma>  \<langle>LET x = FST x\<^sub>p in e; \<rho>; \<kappa>\<rangle> \<Longrightarrow> \<rho> x\<^sub>p = Some \<lbrace>prim.Pair x\<^sub>1 x\<^sub>2, \<rho>\<^sub>p\<rbrace> \<Longrightarrow> \<rho>\<^sub>p x\<^sub>1 = Some \<omega> \<Longrightarrow> (\<V>, \<C>, \<X>, \<Y> . \<Z>) \<Turnstile>\<^sub>\<rho> \<rho>(x \<mapsto> \<omega>)
"
 apply (rule accept_value_accept_val_env.Any, auto)
      apply (erule accept_state.cases, auto)
      apply (erule accept_val_env.cases, auto)
...
lemma flow_state_to_flow_stack_6: "
  (\<V>, \<C>, \<X>, \<Y> . \<Z>) \<Turnstile>\<^sub>\<sigma>  \<langle>LET x = FST x\<^sub>p in e; \<rho>; \<kappa>\<rangle> \<Longrightarrow> \<rho> x\<^sub>p = Some \<lbrace>prim.Pair x\<^sub>1 x\<^sub>2, \<rho>\<^sub>p\<rbrace> \<Longrightarrow> \<rho>\<^sub>p x\<^sub>1 = Some \<omega> \<Longrightarrow> (\<V>, \<C>, \<X>, \<Y> . \<Z>) \<Turnstile>\<^sub>\<kappa>  \<V> (\<lfloor>e\<rfloor>) \<Rrightarrow> \<kappa>
"
 apply (erule accept_state.cases, auto)
done

lemma flow_over_state_6: "
  (\<V>, \<C>, \<X>, \<Y> . \<Z>) \<Turnstile>\<^sub>\<sigma>  \<langle>LET x = FST x\<^sub>p in e; \<rho>; \<kappa>\<rangle> \<Longrightarrow>
  ...
  (\<V>, \<C>, \<X>, \<Y> . \<Z>) \<Turnstile>\<^sub>\<sigma>  \<langle>e; \<rho>(x \<mapsto> \<omega>); \<kappa>\<rangle>
"
 apply (rule accept_state.Any)
...
lemma flow_state_to_flow_exp_7: "
  (\<V>, \<C>, \<X>, \<Y> . \<Z>) \<Turnstile>\<^sub>\<sigma>  \<langle>LET x = SND x\<^sub>p in e; \<rho>; \<kappa>\<rangle> \<Longrightarrow> \<rho> x\<^sub>p = Some \<lbrace>prim.Pair x\<^sub>1 x\<^sub>2, \<rho>\<^sub>p\<rbrace> \<Longrightarrow> 
  \<rho>\<^sub>p x\<^sub>2 = Some \<omega> \<Longrightarrow> (\<V>, \<C>, \<X>, \<Y> . \<Z>) \<Turnstile>\<^sub>e  e
"
 apply (erule accept_state.cases, auto)
 apply (erule accept_exp.cases, auto)
done
...
lemma flow_state_to_flow_env_7: "
  (\<V>, \<C>, \<X>, \<Y> . \<Z>) \<Turnstile>\<^sub>\<sigma>  \<langle>LET x = SND x\<^sub>p in e; \<rho>; \<kappa>\<rangle> \<Longrightarrow> \<rho> x\<^sub>p = Some \<lbrace>prim.Pair x\<^sub>1 x\<^sub>2, \<rho>\<^sub>p\<rbrace> \<Longrightarrow> \<rho>\<^sub>p x\<^sub>2 = Some \<omega> \<Longrightarrow> (\<V>, \<C>, \<X>, \<Y> . \<Z>) \<Turnstile>\<^sub>\<rho> \<rho>(x \<mapsto> \<omega>)
"
 apply (rule accept_value_accept_val_env.Any, auto)
      apply (erule accept_state.cases, auto)
      apply (erule accept_val_env.cases, auto)
...
lemma flow_state_to_flow_stack_7: "
  (\<V>, \<C>, \<X>, \<Y> . \<Z>) \<Turnstile>\<^sub>\<sigma>  \<langle>LET x = SND x\<^sub>p in e; \<rho>; \<kappa>\<rangle> \<Longrightarrow> \<rho> x\<^sub>p = Some \<lbrace>prim.Pair x\<^sub>1 x\<^sub>2, \<rho>\<^sub>p\<rbrace> \<Longrightarrow> \<rho>\<^sub>p x\<^sub>2 = Some \<omega> \<Longrightarrow> (\<V>, \<C>, \<X>, \<Y> . \<Z>) \<Turnstile>\<^sub>\<kappa>  \<V> (\<lfloor>e\<rfloor>) \<Rrightarrow> \<kappa>
"
 apply (erule accept_state.cases, auto)
done

lemma flow_over_state_7: "
  (\<V>, \<C>, \<X>, \<Y> . \<Z>) \<Turnstile>\<^sub>\<sigma>  \<langle>LET x = SND x\<^sub>p in e; \<rho>; \<kappa>\<rangle> \<Longrightarrow>
...
lemma flow_state_to_flow_exp_8: "
 (\<V>, \<C>, \<X>, \<Y> . \<Z>) \<Turnstile>\<^sub>\<sigma>  \<langle>LET x = APP f x\<^sub>a in e; \<rho>; \<kappa>\<rangle> \<Longrightarrow> 
 ...
 (\<V>, \<C>, \<X>, \<Y> . \<Z>) \<Turnstile>\<^sub>e  e\<^sub>l
"
 apply (erule accept_state.cases, auto)
 apply (erule accept_exp.cases, auto)
 apply (erule accept_val_env.cases, auto)
...
lemma flow_state_to_flow_env_8: "
  (\<V>, \<C>, \<X>, \<Y> . \<Z>) \<Turnstile>\<^sub>\<sigma>  \<langle>LET x = APP f x\<^sub>a in e; \<rho>; \<kappa>\<rangle> \<Longrightarrow> 
  \<rho> f = Some \<lbrace>Abs f\<^sub>l x\<^sub>l e\<^sub>l, \<rho>\<^sub>l\<rbrace> \<Longrightarrow> \<rho> x\<^sub>a = Some \<omega>\<^sub>a \<Longrightarrow> 
  (\<V>, \<C>, \<X>, \<Y> . \<Z>) \<Turnstile>\<^sub>\<rho> \<rho>\<^sub>l(f\<^sub>l \<mapsto> \<lbrace>Abs f\<^sub>l x\<^sub>l e\<^sub>l, \<rho>\<^sub>l\<rbrace>, x\<^sub>l \<mapsto> \<omega>\<^sub>a)
"
 apply (rule accept_value_accept_val_env.Any, auto)
           apply (erule accept_state.cases, auto)
...
lemma flow_over_state_8: "
  (\<V>, \<C>, \<X>, \<Y> . \<Z>) \<Turnstile>\<^sub>\<sigma>  \<langle>LET x = APP f x\<^sub>a in e; \<rho>; \<kappa>\<rangle> \<Longrightarrow>
  \<rho> f = Some \<lbrace>Abs f\<^sub>l x\<^sub>l e\<^sub>l, \<rho>\<^sub>l\<rbrace> \<Longrightarrow> \<rho> x\<^sub>a = Some \<omega>\<^sub>a \<Longrightarrow> 
  (\<V>, \<C>, \<X>, \<Y> . \<Z>) \<Turnstile>\<^sub>\<sigma>  \<langle>e\<^sub>l; \<rho>\<^sub>l(f\<^sub>l \<mapsto> \<lbrace>Abs f\<^sub>l x\<^sub>l e\<^sub>l, \<rho>\<^sub>l\<rbrace>, x\<^sub>l \<mapsto> \<omega>\<^sub>a); \<langle>x,e,\<rho>\<rangle> # \<kappa>\<rangle>
"
 apply (rule accept_state.Any)
...
theorem flow_over_state_preservation : "
  \<lbrakk>
    (\<V>, \<C>, \<X>, \<Y> . \<Z>) \<Turnstile>\<^sub>\<sigma> \<sigma>; 
...
lemma flow_seq_step_preservation: "
  (\<V>, \<C>, \<X>, \<Y> . \<Z>) \<Turnstile>\<^sub>\<E> \<E> \<Longrightarrow> leaf \<E> \<pi> \<Longrightarrow> \<E> \<pi> = Some (\<langle>LET x = b in e; \<rho>; \<kappa>\<rangle>) \<Longrightarrow> 
  \<langle>LET x = b in e; \<rho>; \<kappa>\<rangle> \<hookrightarrow> \<sigma>' \<Longrightarrow> (\<V>, \<C>, \<X>, \<Y> . \<Z>) \<Turnstile>\<^sub>\<E> \<E>(\<pi> ;; x \<mapsto> \<sigma>')
"
...
lemma flow_over_pool_to_env_1: "
  ...
  (\<V>, \<C>, \<X>, \<Y> . \<Z>) \<Turnstile>\<^sub>\<rho> \<rho>\<^sub>s(x\<^sub>s \<mapsto> \<lbrace>\<rbrace>)
"
apply (rule accept_value_accept_val_env.Any; auto)
    apply (erule accept_state_pool.cases, auto)
...
lemma flow_over_pool_to_stack_1: "
  (\<V>, \<C>, \<X>, \<Y> . \<Z>) \<Turnstile>\<^sub>\<E> \<E> \<Longrightarrow>
  \<E> \<pi>\<^sub>s = Some (\<langle>LET x\<^sub>s = SYNC x\<^sub>s\<^sub>e in e\<^sub>s; \<rho>\<^sub>s; \<kappa>\<^sub>s\<rangle>) \<Longrightarrow>
  (\<V>, \<C>, \<X>, \<Y> . \<Z>) \<Turnstile>\<^sub>\<kappa>  \<V> (\<lfloor>e\<^sub>s\<rfloor>) \<Rrightarrow> \<kappa>\<^sub>s
"
 apply (erule accept_state_pool.cases, auto)
 apply (drule spec[of _ \<pi>\<^sub>s])
 apply (drule spec[of _ "\<langle>LET x\<^sub>s = SYNC x\<^sub>s\<^sub>e in e\<^sub>s; \<rho>\<^sub>s; \<kappa>\<^sub>s\<rangle>"], auto)
...
lemma flow_over_pool_to_exp_2: "
  (\<V>, \<C>, \<X>, \<Y> . \<Z>) \<Turnstile>\<^sub>\<E> \<E> \<Longrightarrow>
  \<E> \<pi>\<^sub>r = Some (\<langle>LET x\<^sub>r = SYNC x\<^sub>r\<^sub>e in e\<^sub>r; \<rho>\<^sub>r; \<kappa>\<^sub>r\<rangle>) \<Longrightarrow> 
  (\<V>, \<C>, \<X>, \<Y> . \<Z>) \<Turnstile>\<^sub>e  e\<^sub>r
"
 apply (erule accept_state_pool.cases, auto)
 apply (drule spec[of _ \<pi>\<^sub>r])
...
lemma flow_over_pool_to_env_2: "
  ...
  \<rho>\<^sub>r x\<^sub>r\<^sub>e = Some \<lbrace>Recv_Evt x\<^sub>r\<^sub>c, \<rho>\<^sub>r\<^sub>e\<rbrace> \<Longrightarrow> 
  \<rho>\<^sub>r\<^sub>e x\<^sub>r\<^sub>c = Some \<lbrace>c\<rbrace> \<Longrightarrow> 
  (\<V>, \<C>, \<X>, \<Y> . \<Z>) \<Turnstile>\<^sub>\<rho> \<rho>\<^sub>r(x\<^sub>r \<mapsto> \<omega>\<^sub>m)
"
apply (rule accept_value_accept_val_env.Any; auto)
      apply (erule accept_state_pool.cases, auto)
      apply (frule spec[of _ \<pi>\<^sub>s])
...
lemma flow_over_pool_to_stack_2: "
  (\<V>, \<C>, \<X>, \<Y> . \<Z>) \<Turnstile>\<^sub>\<E> \<E> \<Longrightarrow>
  \<E> \<pi>\<^sub>r = Some (\<langle>LET x\<^sub>r = SYNC x\<^sub>r\<^sub>e in e\<^sub>r; \<rho>\<^sub>r; \<kappa>\<^sub>r\<rangle>) \<Longrightarrow>
  (\<V>, \<C>, \<X>, \<Y> . \<Z>) \<Turnstile>\<^sub>\<kappa>  \<V> (\<lfloor>e\<^sub>r\<rfloor>) \<Rrightarrow> \<kappa>\<^sub>r
"
 apply (erule accept_state_pool.cases, auto)
 apply (drule spec[of _ \<pi>\<^sub>r])
 apply (drule spec[of _ "\<langle>LET x\<^sub>r = SYNC x\<^sub>r\<^sub>e in e\<^sub>r; \<rho>\<^sub>r; \<kappa>\<^sub>r\<rangle>"], auto)
...
lemma flow_let_sync_preservation: "
  ...
  \<E> \<pi>\<^sub>r = Some (\<langle>LET x\<^sub>r = SYNC x\<^sub>r\<^sub>e in e\<^sub>r; \<rho>\<^sub>r; \<kappa>\<^sub>r\<rangle>) \<Longrightarrow>
  \<rho>\<^sub>r x\<^sub>r\<^sub>e = Some \<lbrace>Recv_Evt x\<^sub>r\<^sub>c, \<rho>\<^sub>r\<^sub>e\<rbrace> \<Longrightarrow>
  \<rho>\<^sub>r\<^sub>e x\<^sub>r\<^sub>c = Some \<lbrace>c\<rbrace> \<Longrightarrow> (\<V>, \<C>, \<X>, \<Y> . \<Z>) \<Turnstile>\<^sub>\<E> \<E>(\<pi>\<^sub>s ;; x\<^sub>s \<mapsto> \<langle>e\<^sub>s; \<rho>\<^sub>s(x\<^sub>s \<mapsto> \<lbrace>\<rbrace>); \<kappa>\<^sub>s\<rangle>, \<pi>\<^sub>r ;; x\<^sub>r \<mapsto> \<langle>e\<^sub>r; \<rho>\<^sub>r(x\<^sub>r \<mapsto> \<omega>\<^sub>m); \<kappa>\<^sub>r\<rangle>)
"
 apply (rule accept_state_pool.Any, auto)
     apply (rule accept_state.Any)
...
lemma flow_over_pool_to_exp_3: "
  (\<V>, \<C>, \<X>, \<Y> . \<Z>) \<Turnstile>\<^sub>\<E> \<E> \<Longrightarrow> \<E>' = \<E>(\<pi> ;; x \<mapsto> \<langle>e; \<rho>(x \<mapsto> \<lbrace>Ch \<pi> x\<rbrace>); \<kappa>\<rangle>) \<Longrightarrow> 
...
lemma flow_over_pool_to_env_3: "
  (\<V>, \<C>, \<X>, \<Y> . \<Z>) \<Turnstile>\<^sub>\<E> \<E> \<Longrightarrow> \<E>' = \<E>(\<pi> ;; x \<mapsto> \<langle>e; \<rho>(x \<mapsto> \<lbrace>Ch \<pi> x\<rbrace>); \<kappa>\<rangle>) \<Longrightarrow> 
  leaf \<E> \<pi> \<Longrightarrow> \<E> \<pi> = Some (\<langle>LET x = CHAN \<lparr>\<rparr> in e; \<rho>; \<kappa>\<rangle>) \<Longrightarrow> 
  (\<V>, \<C>, \<X>, \<Y> . \<Z>) \<Turnstile>\<^sub>\<rho> \<rho>(x \<mapsto> \<lbrace>Ch \<pi> x\<rbrace>)
"
 apply (rule accept_value_accept_val_env.Any, auto)
      apply (erule accept_state_pool.cases, auto)
      apply (drule spec[of _ \<pi>])
...
lemma flow_over_pool_to_stack_3: "
  (\<V>, \<C>, \<X>, \<Y> . \<Z>) \<Turnstile>\<^sub>\<E> \<E> \<Longrightarrow> \<E>' = \<E>(\<pi> ;; x \<mapsto> \<langle>e; \<rho>(x \<mapsto> \<lbrace>Ch \<pi> x\<rbrace>); \<kappa>\<rangle>) \<Longrightarrow> leaf \<E> \<pi> \<Longrightarrow> \<E> \<pi> = Some (\<langle>LET x = CHAN \<lparr>\<rparr> in e; \<rho>; \<kappa>\<rangle>) \<Longrightarrow> (\<V>, \<C>, \<X>, \<Y> . \<Z>) \<Turnstile>\<^sub>\<kappa>  \<V> (\<lfloor>e\<rfloor>) \<Rrightarrow> \<kappa>
"
 apply (erule accept_state_pool.cases, auto)
 apply (drule spec[of _ \<pi>])
 apply (drule spec[of _ "\<langle>LET x = CHAN \<lparr>\<rparr> in e; \<rho>; \<kappa>\<rangle>"], auto)
...
lemma flow_let_chan_preservation: "
  (\<V>, \<C>, \<X>, \<Y> . \<Z>) \<Turnstile>\<^sub>\<E> \<E> \<Longrightarrow> \<E>' = \<E>(\<pi> ;; x \<mapsto> \<langle>e; \<rho>(x \<mapsto> \<lbrace>Ch \<pi> x\<rbrace>); \<kappa>\<rangle>) \<Longrightarrow> 
  leaf \<E> \<pi> \<Longrightarrow> \<E> \<pi> = Some (\<langle>LET x = CHAN \<lparr>\<rparr> in e; \<rho>; \<kappa>\<rangle>) \<Longrightarrow> 
  (\<V>, \<C>, \<X>, \<Y> . \<Z>) \<Turnstile>\<^sub>\<E> \<E>(\<pi> ;; x \<mapsto> \<langle>e; \<rho>(x \<mapsto> \<lbrace>Ch \<pi> x\<rbrace>); \<kappa>\<rangle>)
"
 apply (rule accept_state_pool.Any, auto)
  apply (rule accept_state.Any)
...
lemma flow_over_pool_to_exp_5: "
  (\<V>, \<C>, \<X>, \<Y> . \<Z>) \<Turnstile>\<^sub>\<E> \<E> \<Longrightarrow> \<E>' = \<E>(\<pi> ;; x \<mapsto> \<langle>e; \<rho>(x \<mapsto> \<lbrace>\<rbrace>); \<kappa>\<rangle>, \<pi>;;.x \<mapsto> \<langle>e\<^sub>c; \<rho>; []\<rangle>) \<Longrightarrow> 
...
lemma flow_over_pool_to_env_5: "
  (\<V>, \<C>, \<X>, \<Y> . \<Z>) \<Turnstile>\<^sub>\<E> \<E> \<Longrightarrow> \<E>' = \<E>(\<pi> ;; x \<mapsto> \<langle>e; \<rho>(x \<mapsto> \<lbrace>\<rbrace>); \<kappa>\<rangle>, \<pi>;;.x \<mapsto> \<langle>e\<^sub>c; \<rho>; []\<rangle>) \<Longrightarrow> 
  leaf \<E> \<pi> \<Longrightarrow> \<E> \<pi> = Some (\<langle>LET x = SPAWN e\<^sub>c in e; \<rho>; \<kappa>\<rangle>) \<Longrightarrow> 
  (\<V>, \<C>, \<X>, \<Y> . \<Z>) \<Turnstile>\<^sub>\<rho> \<rho>(x \<mapsto> \<lbrace>\<rbrace>)"
 apply (rule accept_value_accept_val_env.Any, auto)
      apply (erule accept_state_pool.cases, auto)
      apply (drule spec[of _ \<pi>])
      apply (drule spec[of _ "\<langle>LET x = SPAWN e\<^sub>c in e; \<rho>; \<kappa>\<rangle>"], auto)
...
lemma flow_over_pool_to_stack_6: "
  (\<V>, \<C>, \<X>, \<Y> . \<Z>) \<Turnstile>\<^sub>\<E> \<E> \<Longrightarrow> \<E>' = \<E>(\<pi> ;; x \<mapsto> \<langle>e; \<rho>(x \<mapsto> \<lbrace>\<rbrace>); \<kappa>\<rangle>, \<pi>;;.x \<mapsto> \<langle>e\<^sub>c; \<rho>; []\<rangle>) \<Longrightarrow> 
  leaf \<E> \<pi> \<Longrightarrow> \<E> \<pi> = Some (\<langle>LET x = SPAWN e\<^sub>c in e; \<rho>; \<kappa>\<rangle>) \<Longrightarrow> 
  (\<V>, \<C>, \<X>, \<Y> . \<Z>) \<Turnstile>\<^sub>\<kappa>  \<V> (\<lfloor>e\<^sub>c\<rfloor>) \<Rrightarrow> []
"   
...
lemma flow_let_spawn_preservation: "
  (\<V>, \<C>, \<X>, \<Y> . \<Z>) \<Turnstile>\<^sub>\<E> \<E> \<Longrightarrow> \<E>' = \<E>(\<pi> ;; x \<mapsto> \<langle>e; \<rho>(x \<mapsto> \<lbrace>\<rbrace>); \<kappa>\<rangle>, \<pi>;;.x \<mapsto> \<langle>e\<^sub>c; \<rho>; []\<rangle>) \<Longrightarrow>
  leaf \<E> \<pi> \<Longrightarrow> \<E> \<pi> = Some (\<langle>LET x = SPAWN e\<^sub>c in e; \<rho>; \<kappa>\<rangle>) \<Longrightarrow> 
  (\<V>, \<C>, \<X>, \<Y> . \<Z>) \<Turnstile>\<^sub>\<E> \<E>(\<pi> ;; x \<mapsto> \<langle>e; \<rho>(x \<mapsto> \<lbrace>\<rbrace>); \<kappa>\<rangle>, \<pi>;;.x \<mapsto> \<langle>e\<^sub>c; \<rho>; []\<rangle>)
"
  apply (rule accept_state_pool.Any, auto)
    apply (rule accept_state.Any)
...
theorem flow_preservation_star' : "
  ...
  ((\<V>, \<C>, \<X>, \<Y> . \<Z>) \<Turnstile>\<^sub>\<E> \<E> \<longrightarrow> (\<V>, \<C>, \<X>, \<Y> . \<Z>) \<Turnstile>\<^sub>\<E> \<E>')
"
...
theorem lift_flow_exp_to_state: "(\<V>, \<C>, \<X>, \<Y> . \<Z>) \<Turnstile>\<^sub>e e \<Longrightarrow> (\<V>, \<C>, \<X>, \<Y> . \<Z>) \<Turnstile>\<^sub>\<sigma>  \<langle>e; empty; []\<rangle>"
 apply (rule accept_state.Any, auto)
 apply (rule+, auto, rule)
done

theorem  lift_flow_state_to_pool: "(\<V>, \<C>, \<X>, \<Y> . \<Z>) \<Turnstile>\<^sub>\<sigma>  \<sigma> \<Longrightarrow> (\<V>, \<C>, \<X>, \<Y> . \<Z>) \<Turnstile>\<^sub>\<E> [[] \<mapsto> \<sigma>]"
  apply (rule accept_state_pool.Any)
  apply (case_tac "\<pi> = []", auto)
done

theorem lift_flow_exp_to_pool: "(\<V>, \<C>, \<X>, \<Y> . \<Z>) \<Turnstile>\<^sub>e  e \<Longrightarrow> (\<V>, \<C>, \<X>, \<Y> . \<Z>) \<Turnstile>\<^sub>\<E> [[] \<mapsto> \<langle>e; empty; []\<rangle>]"
