...
\<not> prefix (\<pi>\<^sub>1 ;; l) \<pi>\<^sub>2      \<not> prefix \<pi>\<^sub>2 \<pi>\<^sub>1     \<not> prefix \<pi>\<^sub>1 \<pi>\<^sub>2 
----------------------------------------------------------------
...
(\<not> prefix \<pi>\<^sub>2 (\<pi>\<^sub>1 ;; l) \<and> \<not> prefix (\<pi>\<^sub>1 ;; l) \<pi>\<^sub>2 )
"
