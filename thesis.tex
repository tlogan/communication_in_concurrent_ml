...
The restricted ANF grammar is impractical for a programer to write, yet it is still practical for
...
\begin{lstlisting}[language=normal_lang, escapechar=\%]
  ...
  let srvr = mksr u1 in
  let z10 = spawn ( 
    let p3 = pair srvr r1 in
    let z11 = rqst p3 in
    rslt z11) in
  let p4 = pair srvr l1 in
  let z12 = rqst p4 in
  rslt z12
  \end{lstlisting}
...
The example server implementation is helpful for demonstrating this informal procedure.
...
----TO DO--- shoe complete static environment and static conversation functions
\begin{lstlisting}[language=logic, escapechar=\%]
  fun server_static_env of name -> static_vale set:
    (%$\forall$% x . server_static_env x =
      if x = (Nm "u1") then {SUnt} else
      if x = (Nm "r1") then {SPrm (Rght (Nm "u1"))} else
      if x = (Nm "l1") then {SPrm (Lft (Nm "r1"))} else
      if x = (Nm "l2") then {SPrm (Lft (Nm "l1"))} else
      if x = (Nm "x1'") then {SUnt} else
      if x = (Nm "z1") then {SUnt} else
      if x = (Nm "y1") then {(Lft (Nm "r1")), (Rght (Nm "u1"))} else
      if x = (Nm "z2") then {SUnt} else
      if x = (Nm "y2") then {SUnt} else
      if x = (Nm "u2") then {SUnt} else
      if x = (Nm "u3") then {SUnt} else
      if x = (Nm "mksr") then {SPrm (Abs (Nm _), ...)} else
      if x = (Nm "x2") then {SUnt} else
      if x = (Nm "k1") then {SChn (Nm "k1"))} else
      if x = (Nm "srv") then {} else
      if x = (Nm "srv'") then {} else
      if x = (Nm "x3") then {} else
      if x = (Nm "e1") then {} else
      if x = (Nm "p1") then {} else
      if x = (Nm "v1") then {} else
      if x = (Nm "k2") then {} else
      if x = (Nm "e2") then {} else
      if x = (Nm "z5") then {} else
      if x = (Nm "z6") then {} else
      if x = (Nm "u4") then {} else
      if x = (Nm "z7") then {} else
      if x = (Nm "z8") then {} else
      if x = (Nm "u5") then {} else
      if x = (Nm "rqst") then {} else
      if x = (Nm "x3") then {} else
      if x = (Nm "k3") then {} else
      if x = (Nm "v2") then {} else
      if x = (Nm "k4") then {} else
      if x = (Nm "p2") then {} else
      if x = (Nm "e3") then {} else
      if x = (Nm "z9") then {} else
      if x = (Nm "e4") then {} else
      if x = (Nm "v3") then {} else
      if x = (Nm "srvr") then {} else
      if x = (Nm "z10") then {} else
      if x = (Nm "p3") then {} else
      if x = (Nm "z11") then {} else
      if x = (Nm "p4") then {} else
      if x = (Nm "z12") then {} else
      {})
...
\begin{lstlisting}[language=logic, escapechar=\%]
  predicate static_traversable_val of
    static_value_map -> static_program -> dynamic_value -> bool:
    only
    (%$\forall$% env_a prog_a .
...
server implementation.  The loop basically just wastes time, but is used to demontrate how
traversability handles recursion that does not contain any channel of interest. 
