...
not_static_traceable_pool_sound, lemma static_traversable_pool_preserved_star, the predicate
star_left and its equivalence to star, and induction on star_left concur_step's latter
argument.  Induction with star_left provides
