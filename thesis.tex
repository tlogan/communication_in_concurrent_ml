...
\lstinline[mathescape]{dynamicBuiltOnChanState (Stt t' env' stack') (Ch path$_c$ n$_c$)} in the soundess of
...
\begin{lstlisting}[language=logic, mathescape]
  ...
  * stack: stack chan t env .
  ...
  lemma staticBuiltOnChanSound:
    dynamicBuiltOnChanVal v (Ch path$_c$ x$_c$),
    env n = Some v,
    pool path = Some (Stt t' env' stack'),
    staticEvalPool staticEnv staticComm pool,
    staticLiveChanPool staticEnv entr exit x$_c$ pool,
