...
\begin{lstlisting}[language=logic, mathescape]
  ...
  * $\forall$ t0 t$_b$ n$_f$ n$_p$ t$_b$ . 
  ...
  predicate staticReachableVal: term -> dynamic_value -> bool
  where only
    $\forall$ t0 .
  ...
  * $\forall$ t0 t env .
  ...
  predicate staticReachableEnv: term -> env -> bool
  where only
    $\forall$ t0 env
      if
        $\forall$ n v . if env n = Some v then
...
\begin{lstlisting}[language=logic, mathescape]
  ...
  * $\forall$ n t' graph staticEnv n$_c$ .
      if
        ...
        staticFlowsAcceptTm staticEnv graph t0 t'
      then
        staticFlowsAcceptTm staticEnv graph t0 (Bind n (Atom (RecvEvt n$_c$)) t')
  * $\forall$ n t' graph staticEnv n1 n2 .
      if
        (NBnd n , MNxt, termId t') $\in$ graph,
        staticFlowsAcceptTm staticEnv graph t0 t'
  ...
  * $\forall$ n t' graph staticEnv n$_s$ .
      if
        ...
        staticFlowsAcceptTm staticEnv graph t0 t'
      then
       staticFlowsAcceptTm staticEnv graph t0 (Bind n (Atom (Lft n$_s$)) t')
  * $\forall$ n t' graph staticEnv n$_s$ .
      if
        (NBnd n , MNxt, termId t') $\in$ graph,
        staticFlowsAcceptTm staticEnv graph t0 t'
      then
        staticFlowsAcceptTm staticEnv graph t0 (Bind n (Atom (Rht n$_s$)) t')
  * $\forall$ n t' graph staticEnv t$_b$ n$_f$ n$_p$ .
      if
        (NBnd n , MNxt, termId t') $\in$ graph,
        staticFlowsAcceptTm staticEnv graph t0 t',
        staticFlowsAcceptTm staticEnv graph t0 t$_b$
      then
        staticFlowsAcceptTm staticEnv graph t0 (Bind n (Atom (Fun n$_f$ n$_p$ t$_b$)) t')
  * $\forall$ n t' t$_c$ graph staticEnv.
      if
        {(NBnd n, MNxt, termId t'),
          (NBnd n, MSpwn, termId t$_c$)} $\subseteq$ graph,
        staticFlowsAcceptTm staticEnv graph t0 t$_c$,
        staticFlowsAcceptTm staticEnv graph t0 t'
      then
        staticFlowsAcceptTm staticEnv graph t0 (Bind n (Spwn t$_c$) t')
  * $\forall$ n t' graph staticEnv n$_{se}$ .
      if
        (NBnd n , MNxt, termId t') $\in$ graph,
      * $\forall$ n$_{sc}$ n$_m$ n$_c$ n$_y$.
          if
            ...
            (SChn n$_c$) $\in$ staticEnv n$_{sc}$,
            staticRecvId staticEnv t0 n$_c$ (NBnd n$_y$)
          then
            (NBnd n, ESend n$_{se}$, NBnd n$_y$) $\in$ graph),
        staticFlowsAcceptTm staticEnv graph t0 t'
      then
        staticFlowsAcceptTm staticEnv graph t0 (Bind n (Sync n$_{se}$) t')
  * $\forall$ n t' graph staticEnv n$_p$ .
      if
        (NBnd n , MNxt, termId t') $\in$ graph,
        staticFlowsAcceptTm staticEnv graph t0 t',
      then
        staticFlowsAcceptTm staticEnv graph t0 (Bind n (Fst n$_p$) t')
  * $\forall$ n t' graph staticEnv n$_p$ .
      if
        (NBnd n , MNxt, termId t') $\in$ graph,
        staticFlowsAcceptTm staticEnv graph t0 t',
      then
        staticFlowsAcceptTm staticEnv graph t0 (Bind n (Snd n$_p$) t')
  * $\forall$ n t$_l$ t$_r$ t' graph staticEnv n$_s$ .
      if
        {
          (NBnd n, MCll, termId t$_l$),
        ...
        staticFlowsAcceptTm staticEnv graph t0 t$_l$,
        staticFlowsAcceptTm staticEnv graph t0 t$_r$,
        staticFlowsAcceptTm staticEnv graph t0 t'
      then
        staticFlowsAcceptTm staticEnv graph t0 (Bind n (Case n$_s$ n$_l$ t$_l$ n$_r$ t$_r$) t')
  * $\forall$  staticEnv n$_f$ n t' n n$_a$ .
      if
        ...
        staticFlowsAcceptTm staticEnv graph t0 t'
      then
        staticFlowsAcceptTm staticEnv graph t0 (Bind n (App n$_f$ n$_a$) t')
