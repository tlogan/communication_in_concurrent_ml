...
channel value, and the lemma for soundess of a name in any state's environment
...
order to potray a clear connection to
...
The soundness of lack of reachbility follows the the definitions
...
The soudness over pools follows from the lemma that the leftward
...
leftward star and constructs the static rechability
...
send site and the receive site of syncrhonization. Modes for typical control flow of
...
Additionally the soudness theorem follows from the soundness of lack of static traceability,
