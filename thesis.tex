...
\begin{lstlisting}[style=codestyle1, escapechar=\%]
  inductive 
    ...
    Intro:
      %$\forall$% x v .
        env x = Some v %$\longrightarrow$%
        {rslt_var v} %$\subseteq$% V x %$\land$% flows_passable_val V F v %$\Longrightarrow$%
      flows_passable_env V F env |
    ...
    Send_Evt:
      flows_passable_env V F env %$\Longrightarrow$%
      flows_passable_val V F (VClsr (Send_Evt _ _) env) |
    Recv_Evt:
      flows_passable_env V F env %$\Longrightarrow$%
      flows_passable_val V F (VClsr (Recv_Evt _) env) |
    Left:
      flows_passable_env V F env %$\Longrightarrow$%
      flows_passable_val V F (VClsr (Left _) env) |
    Right:
      flows_passable_env V F env %$\Longrightarrow$%
      flows_passable_val V F (VClsr (Right _) env) |
    Abs:
      flows_passable V F e %$\Longrightarrow$% 
      flows_passable_env V F  env %$\Longrightarrow$%
      flows_passable_val V F (VClsr (Abs f x e) env) |
  Pair:
    flows_passable_env V F env %$\Longrightarrow$%
    flows_passable_val V F (VClsr (Pair _ _) env) 



  inductive flows_passable_stack ::
    abstract_env %$\Rightarrow$% flow_set %$\Rightarrow$% cont list %$\Rightarrow$% bool where
    Empty:
      flows_passable_stack V F [] |
    Nonempty:
      flows_passable V F e %$\Longrightarrow$%
      flows_passable_env V F env %$\Longrightarrow$%
      flows_passable_stack V F k %$\Longrightarrow$% 
      flows_passable_stack V F ((Ctn x e env) # k))
  ...
  inductive
    ...
    Intro:
      %$\forall$% pi e env k .
        ...
        flows_passable V F e %$\land$%
        flows_passable_env V F env %$\land$%
        flows_passable_stack V F k %$\Longrightarrow$% 
...
lemma flows_passable_pool_implies_static_traceable: "
  ...
  concur_step
    ...
    (trpl', ys') %$\Longrightarrow$% 
  static_eval (V, C) e %$\Longrightarrow$%
  flows_passable_pool V F trpl' %$\Longrightarrow$%
  isEnd (NLet x) %$\Longrightarrow$%
  %$\exists$% path . 
