...
(%$\forall$% env_a x_e x convo_a  e'.
  if
    (%$\forall$% x_sc x_m x_c . 
      ...
      then
        SUnt %$\in$% env_a x and env_a x_m %$\subset$% convo_a x_c) and
...
(%$\forall$% env_a f x_a x convo_a e' . 
  if
    (%$\forall$% f_p x_p e_b . if (SPrm (Abs f_p x_p e_b)) %$\in$% env_a f then 
      ...
      env_a (result_name e_b) %$\subset$% env_a x) and
...
(%$\forall$% prog0 x x_e e' x_sc x_m env_a x_c .
  if
    ...
    (SPrm (SendEvt x_sc x_m)) %$\subset$% env_a x_e and 
    (SChn x_c) %$\in$% env_a x_sc
  then
...
(%$\forall$% x e' e_c prog_a env_a.
  if
    {(NLet x, MNxt, top_label e'),
      (NLet x, MSpwn, top_label e_c)} %$\subset$% prog_a and
...
(%$\forall$% x e_l e_r e' prog_a env_a x_s .
  if
    {(NLet x, MCll, top_label e_l),
      ...
      (NResult (result_name e_r), MRtn, top_label e')} %$\subset$% prog_a and
  ...
  if
    (%$\forall$% f_p x_p e_b . if (SPrm (Abs f_p x_p e_b)) %$\in$% env_a f then 
      {(NLet x, MCll, top_label e_b),
        (NResult (result_name e_b), MRtn, top_label e')} %$\subset$% prog_a) and
...
(%$\forall$% y e prog_a env_a prog_a env stack x env .
  if 
    {(NResult y, MRtn, top_label e)} %$\subset$% prog_a and
    static_traversable env_a prog_a e and
...
(%$\forall$%  exit x entr e_b x_p x env_a x_c e' f . 
  if
    (exit (NLet x) - {x}) %$\cup$% (entr (top_label e_b) - {x_p}) %$\subset$% entr (NLet x) and
...
(%$\forall$% exit x entr e' e_c x_c env_a .
  if
    (exit (NLet x) - {x}) %$\subset$% entr (NLet x) and
    entr (top_label e') %$\cup$% entr (top_label e_c) %$\subset$% exit (NLet x) and
