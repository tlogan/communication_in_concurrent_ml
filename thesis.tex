...
\begin{lstlisting}[language=logic, mathescape]
  ...
  (\forall t0 n t$_c$ t' .
    if 
      static_reachable_forward t0 (Bind n (Spwn t$_c$) t')
    then
      static_reachable_forward t0 t$_c$
  ),
  (\forall t0 n n$_s$ n$_l$ t$_l$ n$_r$ t$_r$ t' .
    if
      static_reachable_forward t0 (Bind n (Case n$_s$ n$_l$ t$_l$ n$_r$ t$_r$) t')
    then
      static_reachable_forward t0 t$_l$
  ),
  (\forall t0 n n$_s$ n$_l$ t$_l$ n$_r$ t$_r$ t' .
    if
      static_reachable_forward t0 (Bind n (Case n$_s$ n$_l$ t$_l$ n$_r$ t$_r$) t')
    then
      static_reachable_forward t0 t$_r$
  ),
  (\forall t0 n n$_f$ n$_p$ t$_b$ t' .
    if
      static_reachable_forward t0 (Bind n (Atom (Fun n$_f$ n$_p$ t$_b$)) t')
    then
      static_reachable_forward t0 t$_b$
  ),
  (\forall t0 n n$_f$ n$_p$ t$_b$ t' .
    if
  ...
  only
  (\forall t0 n$_c$ n$_m$ .
    static_reachable_over_atom t0 (SendEvt n$_c$ n$_m$)
  ),
  (\forall t0 n$_c$ .
    static_reachable_over_atom t0 (RecvEvt n$_c$)
  ),
  (\forall t0 n1 n2 .
    static_reachable_over_atom t0 (Pair n1 n2)
  ),
  (\forall t0 n$_l$ .
    static_reachable_over_atom t0 (Lft n$_l$)
  ),
  (\forall t0 n$_r$
    static_reachable_over_atom t0 (Rht n$_r$)
  ),
  (\forall t0 t$_b$ n$_f$ n$_p$ t$_b$ . 
    if
      static_reachable_forward t0 t$_b$ 
    then
      static_reachable_over_atom t0 (Fun n$_f$ n$_p$ t$_b$)
  )
  ...
  (\forall t0 t$_k$ env$_k$ stack' .
    if
      static_reachable_forward t0 t$_k$, 
      static_reachable_over_env t0 env$_k$,
      static_reachable_over_stack t0 stack' 
    then
    static_reachable_over_stack t0 ((Ctn n$_k$ t$_k$ env$_k$ # stack'))
  )
...
\begin{lstlisting}[language=logic, mathescape]
  ...
  (\forall n t' graph static_env t$_b$ n$_f$ n$_p$ .
    if
      (NBnd n , MNxt, term_id t') \in graph,
      static_flows_accept static_env graph t',
      static_flows_accept static_env graph t$_b$
    then
      static_flows_accept static_env graph (Bind n (Atom (Fun n$_f$ n$_p$ t$_b$)) t')
  ),
  (\forall n t' p_c graph static_env.
    if
...
\begin{lstlisting}[language=logic, mathescape]
  theorem static_one_shot_sound:
  \forall t0 pool comm static_env static_comm n$_c$ path$_c$ . 
    if
      star dynamic_eval [[] -> (Stt t0 [->] []] {} pool comm,
      static_eval static_env static_comm t0,
      static_one_shot static_env t0 n$_c$
...
\begin{lstlisting}[language=logic, mathescape]
  ...
  (\forall path static_path n .
    ...
    then
      paths_correspond
        (path @ [DRtn n])
      (static_path @ [(NRslt n, MRtn)])
  )

  predicate paths_correspond_mod_chan
  of pool -> communication -> chan -> dynamic_path -> static_path -> bool:
  only
  (\forall pool path$_c$ n$_c$ path$_sfx$ stt static_path comm .
    if
      pool (path_c @ (DNxt n$_c$) # path$_sfx$) = Some stt,
      paths_correspond ((DNxt n$_c$) # path$_sfx$) static_path
    then
      paths_correspond_mod_chan
        (pool, comm) (Chan path$_c$ n$_c$)
        (path$_c$ @ (DNxt n$_c$) # path$_sfx$) static_path
  ),
  (\forall pool path$_r$ n$_r$ path_sfx stt  path$_s$ n$_s$ n$_se$ t$_sy$ env$_sy$ stack$_sy$
    n$_r$e t$_ry$ env$_ry$ stack$_ry$ c$_c$ comm c static_path$_re$ static_path$_sfx$ . 
    if
      ...
      dynamic_built_on_chan_var env$_ry$ c n$_r$, 
      paths_correspond_mod_chan pool comm c path$_s$ static_path$_pre$,
      paths_correspond path_$sfx$ static_path$_sfx$
    then
      paths_correspond_mod_chan pool comm c
        (path$_r$ @ (DNxt n$_r$) # path$_sfx$)
        (static_path$_pre$ @ (NBnd n$_s$, ESend n$_se$) # (NBnd n$_r$, MNxt) # static_path$_sfx$))
\end{lstlisting}
...
\begin{lstlisting}[language=logic, mathescape]
  ...
  lemma static_traceable_complete: 
  \forall t0 pool comm path n b p' env stack static_env static_comm
  ...
  lemma static_inclusive_complete:
  \forall t0 pool comm static_env entr exit n$_c$ graph static_comm
    ...
    if
      ...
      static_traceable graph entr exit
        (NBnd n$_c$) (static_send_id static_env t0 n$_c$) static_path1, 
      pool path2 = Some stt2, 
      paths_correspond_mod_chan pool comm (Chan path_c n$_c$) path2 static_path2, 
      static_traceable graph entr exit
        (NBnd n$_c$) (static_send_id static_env t0 n$_c$) static_path2
    then
      static_inclusive static_path1 static_path2
\end{lstlisting}
