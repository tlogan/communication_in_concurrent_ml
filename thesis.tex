...
goal: $\vdash$ sorted lte (Cons (S Z) (Cons (S Z) (Cons (S (S (S Z))) Nil)))
apply (rule lt)
goal: $\vdash$ lte Z Z
goal: $\vdash$ sorted lte (Cons (S Z) (Cons (S Z) (Cons (S (S (S Z))) Nil)))
apply (rule eq)
goal: $\vdash$ sorted lte (Cons (S Z) (Cons (S Z) (Cons (S (S (S Z))) Nil)))
apply (rule cons)
goal: $\vdash$ lte (S Z) (S Z)
goal: $\vdash$ sorted lte (Cons (S Z) (Cons (S (S (S Z))) Nil))
apply (rule eq)
goal: $\vdash$ sorted lte (Cons (S Z) (Cons (S (S (S Z))) Nil))
apply (rule cons)
goal: $\vdash$ lte (S Z) (S (S (S Z)))
goal: $\vdash$ sorted lte (Cons (S (S (S Z))) Nil)
apply (rule lt)
goal: $\vdash$ lte (S Z) (S (S Z))
goal: $\vdash$ sorted lte (Cons (S (S (S Z))) Nil)
apply (rule lt)
goal: $\vdash$ lte (S Z) (S Z)
goal: $\vdash$ sorted lte (Cons (S (S (S Z))) Nil)
