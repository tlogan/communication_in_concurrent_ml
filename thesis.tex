...
static channels. To describe communication statically, it is helpful to identify the entry
...
calling, spawning, and returning. A transition is a triplet of an entry_point, representing a point in
the progra, a control edge, and another entry_point.  A static\_point is just an entry_point and a mode,
without the destination entry_point.  A static\_path is a list of static\_points.  
