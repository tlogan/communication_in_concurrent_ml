...
inductive static_traceable :: "(label * 'a * label) set ⇒ label ⇒ (label ⇒ bool) ⇒ (label * 'a) list ⇒ bool" where
  Empty: "
    isEnd start ⟹
    static_traceable F start isEnd []
  " |
  Step: "
    static_traceable F start (λ l . l = middle) path ⟹
    isEnd end ⟹
    {(middle, edge, end)} ⊆ F ⟹
...
inductive static_inclusive :: "abstract_path ⇒ abstract_path ⇒ bool" where
  Prefix1: "
    prefix π⇩1 π⇩2 ⟹
    static_inclusive π⇩1 π⇩2
  " |
  Prefix2: "
    prefix π⇩2 π⇩1 ⟹
    static_inclusive π⇩1 π⇩2
  " |
  Spawn1: "
    static_inclusive (π @ (NLet x, ESpawn) # π⇩1) (π @ (NLet x, ENext) # π⇩2)
  " |
  Spawn2: "
    static_inclusive (π @ (NLet x, ENext) # π⇩1) (π @ (NLet x, ESpawn) # π⇩2)
  "
...
inductive static_one_shot :: "abstract_env ⇒ exp ⇒ var ⇒ bool" where
  Sync: "
    every_two (static_traceable F (top_label e) (static_send_label V e xC)) singular ⟹
    static_traversable env_a graph e ⟹
...
inductive static_one_to_one :: "abstract_env ⇒ exp ⇒ var ⇒ bool" where
  Sync: "
    every_two (static_traceable F (top_label e) (static_send_label V e xC)) noncompetitive ⟹
    every_two (static_traceable F (top_label e) (static_recv_label V e xC)) noncompetitive ⟹
    static_traversable env_a graph e ⟹
