...
\begin{lstlisting}[language=logic, mathescape]
  ...
  (\forall t0 n p$_c$ t' .
    if 
      static_reachable_forward t0 (Bind n (Spwn p$_c$) t')
    then
      static_reachable_forward t0 p$_c$
  ),
  ...
  (\forall t0 n n$_f$ n$_p$ t$_b$ t' .
    if
      static_reachable_forward t0 (Bind n b t')
    then
  ...
  (\forall t0 p env .
    if
      static_reachable_over_atom t0 p, 
      static_reachable_over_env t0 env
    then
      static_reachable_over_val t0 (VAtm p env)
  )
