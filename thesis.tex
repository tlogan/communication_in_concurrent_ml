...
every function and application to be bound to a name allows the operational
semantics to maintain graph information that simplifies proofs of soundness \cite{}.
