...
soundness semantics ... 
  ...
  To prove the soundness of communication topologies, it is useful to define predicates that relate the the static evaluation of programs to ther elements of the dynamic semantics, including values, environments, continuation stacks, and trace pools. 
