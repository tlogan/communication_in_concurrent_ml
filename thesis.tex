...
inductive static_reachable :: "exp ⇒ exp ⇒ bool"  where
  Refl : "
    static_reachable e e
  " | 
  Let_Spawn_Child: "
    static_reachable e⇩c e ⟹
    static_reachable (Let x (Spwn e⇩c) e⇩n) e
  " |
  let_case_left: "
    static_reachable e⇩l e ⟹
    static_reachable (Let x (Case x⇩s x⇩l e⇩l x⇩r e⇩r) e⇩n) e
  " |
  let_case_right: "
    static_reachable e⇩r e ⟹
    static_reachable (Let x (Case x⇩s x⇩l e⇩l x⇩r e⇩r) e⇩n) e
  " |
  Let_Abs_Body: "
    static_reachable e⇩b e ⟹
    static_reachable (Let x (Prim (Abs f x⇩p e⇩b)) e⇩n) e
  " | 
  Let: "
    static_reachable e⇩n e ⟹
    static_reachable (Let x b e⇩n) e
  "
