...
entry_point whose state has the next expression and the environment updated
with the unit value bound to
the let binding name, and the original continuation stack. For the other, the leaf path
extended with an entry_point indicating a spawning transition.  Its state has the spawned
...
there is an additional condition that the transition from a result point to the entry_point of
