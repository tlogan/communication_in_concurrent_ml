...
\begin{lstlisting}[style=codestyle1, escapechar=\%]
  inductive
    flows_passable ::
      ...
      exp %$\Rightarrow$% bool  where
    Rslt:
      flows_passable V F (Rslt x) |
    let_Unit:
      {(NLet x, ENext, top_node_label e)} %$\subseteq$% F %$\Longrightarrow$%
      flows_passable V F e  %$\Longrightarrow$%
      flows_passable V F (Let x Unt e) |
    let_Chan:
      {(NLet x, ENext, top_node_label e)} %$\subseteq$% F %$\Longrightarrow$%
      flows_passable V F e %$\Longrightarrow$%
      flows_passable V F (Let x MkChn e) |
    let_Send_Evt:
      {(NLet x, ENext, top_node_label e)} %$\subseteq$% F %$\Longrightarrow$%
      flows_passable V F e %$\Longrightarrow$%
      flows_passable V F (Let x = (SendEvt xc xm) e) |
    let_Recv_Evt:
      {(NLet x, ENext, top_node_label e)} %$\subseteq$% F %$\Longrightarrow$%
      flows_passable V F e %$\Longrightarrow$%
      flows_passable V F (Let x = (RecvEvt xc) in e) |
    let_Pair:
      {(NLet x, ENext, top_node_label e)} %$\subseteq$% F %$\Longrightarrow$%
      flows_passable V F e %$\Longrightarrow$%
      flows_passable V F (Let x (Pair x1 x2) e) |
    let_Left:
      {(NLet x, ENext, top_node_label e)} %$\subseteq$% F %$\Longrightarrow$%
      flows_passable V F e %$\Longrightarrow$%
      flows_passable V F (Let x (Lft xp) e) |
    let_Right:
      {(NLet x, ENext, top_node_label e)} %$\subseteq$% F %$\Longrightarrow$%
      flows_passable V F e %$\Longrightarrow$%
      flows_passable V F (Let x (Rht xp) e)" |
    let_Abs:
      {(NLet x, ENext, top_node_label e)} %$\subseteq$% F %$\Longrightarrow$%
      flows_passable V F eb %$\Longrightarrow$%
      flows_passable V F e %$\Longrightarrow$%
      flows_passable V F (Let x (Abs f xp eb) e) |
    let_Spawn:
      {
        (NLet x, ENext, top_node_label e),
        (NLet x, ESpawn, top_node_label ec)}
        %$\subseteq$% F %$\Longrightarrow$%
      flows_passable V F ec %$\Longrightarrow$%
      flows_passable V F e %$\Longrightarrow$%
      flows_passable V F (Let x (Spwn ec)  e) |
    let_Sync:
      {(NLet x, ENext, top_node_label e)} %$\subseteq$% F %$\Longrightarrow$%
      flows_passable V F e %$\Longrightarrow$%
      flows_passable V F (Let x (Sync xSE) e) |
    let_Fst:
      {(NLet x, ENext, top_node_label e)} %$\subseteq$% F %$\Longrightarrow$%
      flows_passable V F e %$\Longrightarrow$%
      flows_passable V F (Let x (Fst xp) e) |
    let_Snd:
      {(NLet x, ENext, top_node_label e)} %$\subseteq$% F %$\Longrightarrow$%
      flows_passable V F e %$\Longrightarrow$%
      flows_passable V F (Let x (Snd xp) e) |
    let_Case:
      {
        ...
        %$\subseteq$% F %$\Longrightarrow$%
      flows_passable V F el %$\Longrightarrow$%
      flows_passable V F er %$\Longrightarrow$%
      flows_passable V F e %$\Longrightarrow$%
      flows_passable V F (Let x (Case xs xl el xr er) e) |
    let_App:
      %$\forall$% fp xp eb .
        APrim (Abs fp xp eb) %$\in$% V f %$\longrightarrow$%
        {
          ...
          %$\subseteq$% F %$\Longrightarrow$%
        flows_passable V F e %$\Longrightarrow$%
        flows_passable V F (Let x (App f xa) e)
...
\begin{lstlisting}[style=codestyle1, escapechar=\%]
  ...
  Prefix2:
    ...
    static_inclusive pi1 pi2 |
  Spawn1:
    pi @ (NLet x, ESpawn) # pi1 ≍ pi @ (NLet x, ENext) # pi2 |
  Spawn2:
    pi @ (NLet x, ENext) # pi1 ≍ pi @ (NLet x, ESpawn) # pi2
  \end{lstlisting}
...
\begin{lstlisting}[style=codestyle1, escapechar=\%]
  ...
  equal:
    ...
    singular pi1 pi2 |
  exclusive:
    ¬ (static_inclusive pi1 pi2) %$\Longrightarrow$% 
    singular pi1 pi2
  ...
  inductive
    ...
    exclusive:
      ¬ (not_inclusive pi1 pi2) %$\Longrightarrow$% 
      noncompetitive pi1 pi2
  \end{lstlisting}
...
\begin{lstlisting}[style=codestyle1, escapechar=\%]
  ...
  ([[] ↦ ⟨e;Map.empty;[]⟩], {}) →* (ℰ', H') %$\Longrightarrow$% 
  ℰ' pi1 ≠ None %$\Longrightarrow$% 
  ℰ' pi2 ≠ None %$\Longrightarrow$% 
...
pathSync = pathSynca ∨ (¬ pathSynca ≍ pathSync) %$\Longrightarrow$% 
...
where
  Intro: "
    %$\forall$% x ω . ρ x = Some ω %$\longrightarrow$% {|ω|} %$\subseteq$% 𝒱 x ∧ flows_passable_val V F ω %$\Longrightarrow$%
    flows_passable_env V F ρ
  " |
  ...
  Send_Evt: "
    flows_passable_env V F ρ %$\Longrightarrow$%
    flows_passable_val V F (VClosure (Send_Evt _ _) ρ)
  " |

  Recv_Evt: "
    flows_passable_env V F ρ %$\Longrightarrow$%
    flows_passable_val V F (VClosure (Recv_Evt _) ρ)
  " |

  Left: "
    flows_passable_env V F ρ %$\Longrightarrow$%
    flows_passable_val V F (VClosure (Left _) ρ)
  " |

  Right: "
    flows_passable_env V F ρ %$\Longrightarrow$%
    flows_passable_val V F (VClosure (Right _) ρ)
  " |

  Abs: "
    flows_passable V F e %$\Longrightarrow$% 
    flows_passable_env V F  ρ %$\Longrightarrow$%
    flows_passable_val V F (VClosure (Abs f x e) ρ)
  " |

  Pair: "
    flows_passable_env V F ρ %$\Longrightarrow$%
    flows_passable_val V F (VClosure (Pair _ _) ρ)
  " 
...
\begin{lstlisting}[style=codestyle1, escapechar=\%]
  ...
  flows_passable_pool V F ([[] ↦ ⟨e;Map.empty;[]⟩]) %$\Longrightarrow$%
  (V, C) ⊨e e %$\Longrightarrow$%
  ℰ' pi = Some (⟨Let x = b in en;ρ;κ⟩) %$\Longrightarrow$%
  ([[] ↦ ⟨e;Map.empty;[]⟩], {}) →* (ℰ', H') %$\Longrightarrow$%
  isEnd (NLet x) %$\Longrightarrow$%
  flows_passable_pool V F ℰ'
"
sorry
...
lemma flows_passable_pool_implies_static_traceable: "
  ...
  ([[] ↦ ⟨e;Map.empty;[]⟩], {}) →* (ℰ', H') %$\Longrightarrow$% 
  (V, C) ⊨e e %$\Longrightarrow$%
  flows_passable_pool V F ℰ' %$\Longrightarrow$%
  isEnd (NLet x) %$\Longrightarrow$%
  ∃ path . 
