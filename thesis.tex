...
semantics of the programming language.  I do not formally prove that the specialized implementations are behaviorally equivalent to
a generic implementation, but I suggest some plausible examples implementations.  Additionally, I do not prove the the relation
between input programs and output topologies is a computable procedure, although the syntax directed structure of the definitions
gives strong evidence of computability. 
