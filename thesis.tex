...
which only contained synchronization on sending and receiving events.  I originally, wanted to extend the analysis
to encompass a more generalized notion of events, along with the evenet combinator for choice.  However, I quickly
...
to easily extend the semantics later, by using Isabelle/HOL to pinpoint where the proofs and specifications break upon
changes.
