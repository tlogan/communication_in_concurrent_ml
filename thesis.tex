...
\begin{lstlisting}[language=logic, mathescape]
  ...
  * $\forall$ path2 path1 .
  ...
  predicate oneShot: pool -> chan -> bool where
    $\forall$ pool c .
      if
  ...
  predicate oneToMany: pool -> chan -> bool where
    $\forall$ pool c .
      if
  ...
  predicate manyToOne: pool -> chan -> bool where
    $\forall$ pool c .
      if
  ...
  predicate oneToOne: pool -> chan -> bool where
    $\forall$ pool c.
      if
        oneToMany pool c,
        manyToOne pool c
...
\begin{lstlisting}[language=logic, mathescape]
  predicate staticEval:
    static_value_map -> static_value_map -> term -> bool where
  ...
  * $\forall$ n$_1$ n$_2$ staticEnv n staticComm t' .
      if
        (SAtm (Pair n$_1$ n$_2$)) $\in$ staticEnv n,
        staticEval staticEnv staticComm t'
      then
        staticEval staticEnv staticComm (Bind n (Atom (Pair n$_1$ n$_2$)) t')
  ...
  * $\forall$ staticEnv n$_t$ n staticComm t' . 
      if
        $\forall$ n$_1$ n$_2$ . if (SAtm (Pair n$_1$ n$_2$)) $\in$ staticEnv n$_t$ then
          staticEnv n$_1$ $\subseteq$ staticEnv n),
        staticEval staticEnv staticComm t'
      then
  ...
  * $\forall$ staticEnv n$_t$ n staticComm t' . 
      if
        $\forall$ n$_1$ n$_2$ . if (SAtm (Pair n$_1$ n$_2$)) $\in$ staticEnv n$_t$ then
          staticEnv n$_2$ $\subseteq$ staticEnv n),
        staticEval staticEnv staticComm t'
      then
...
\begin{lstlisting}[language=logic, mathescape]
  predicate staticSendId:
    static_value_map -> term -> name -> termId -> bool where
    $\forall$ t$_0$ n n$_e$ t' n$_{sc}$ n$_m$ staticEnv n$_c$ .
      if
        staticReachable t$_0$ (Bind n (Sync n$_e$) t'),
        (SAtm (SendEvt n$_{sc}$ n$_m$)) $\subseteq$ staticEnv n$_e$, 
        (SChn n$_c$) $\in$ staticEnv n$_{sc}$
      then
        staticSendId staticEnv t$_0$ n$_c$ (NBnd n)

  predicate staticRecvId:
    static_value_map -> term -> name -> termId -> bool where
    $\forall$ t$_0$ n n$_e$ t' n$_{rc}$ staticEnv n$_c$ .
      if
        staticReachable t$_0$ (Bind n (Sync n$_e$) t'),
        (SAtm (RecvEvt n$_{rc}$)) $\in$ staticEnv n$_e$, 
        (SChn n$_c$) $\in$ staticEnv n$_{rc}$ 
      then
        staticRecvId staticEnv t$_0$ n$_c$ (NBnd n)
\end{lstlisting}
...
\begin{lstlisting}[language=logic, mathescape]
  ...
  * $\forall$ n t' graph staticEnv n$_1$ n$_2$ .
      if
        ...
        staticFlowsAccept staticEnv graph t'
      then
        staticFlowsAccept staticEnv graph (Bind n (Atom (Pair n$_1$ n$_2$)) t')
...
\begin{lstlisting}[language=logic, mathescape]
  predicate staticTraceable:
    flow set -> termId -> (termId -> bool) -> static_path -> bool where
...
\begin{lstlisting}[language=logic, mathescape]
  theorem staticOneShotSound: 
    $\forall$ staticEnv staticComm t$_0$ n$_c$ pool comm path$_c$ .
      if
  ...
  theorem staticOneToManySound:
    $\forall$ staticEnv staticComm t$_0$ n$_c$ pool comm path$_c$. 
      if 
        staticEval staticEnv staticComm t$_0$, 
        staticOneToMany staticEnv t$_0$ n$_c$, 
        star dynamicEval [[] -> (Stt t$_0$ [->] [])] {} pool comm
      then
  ...
  theorem staticManyToOneSound:
    $\forall$ staticEnv staticComm t$_0$ n$_c$ pool comm path$_c$. 
      if
        staticEval staticEnv staticComm t$_0$, 
        staticManyToOne staticEnv t$_0$ n$_c$, 
        star dynamicEval [[] -> (Stt t$_0$ [->] [])] {} pool comm
      then
...
\begin{lstlisting}[language=logic, mathescape]
  ...
  * $\forall$ path staticPath n .
  ...
  lemma staticTraceableSound:
    $\forall$ t$_0$ pool comm path n c t' env stack staticEnv staticComm graph isEnd .
      if
        star dynamicEval ([[] -> (Stt t$_0$ [->] [])], {}) (pool, comm), 
        pool path = Some (Stt (Bind n c t') env stack),
        staticEval staticEnv staticComm t$_0$,
      ...
      then
        exists staticPath . 
          pathsCorrespond path staticPath, 
          staticTraceable graph (termId t$_0$) isEnd staticPath

  lemma staticInclusiveSound:
    $\forall$ t$_0$ pool comm path1 stt1 path2 stt2 staticPath1 staticPath2 . 
      if
        star dynamicEval [[] -> (Stt t$_0$ [->] [])] {} pool comm
  ...
  lemma staticSendIdSound:
    $\forall$ t$_0$ pool comm path n n$_e$ t' env stack n$_{sc}$ n$_m$ env' path$_c$ n$_c$ .
      if
        star dynamicEval [[] -> (Stt t$_0$ [->] [])] {} pool comm, 
        pool path = Some (Stt (Bind n (Sync n$_e$) t') env stack), 
...
\begin{lstlisting}[language=logic, mathescape]
  predicate staticFlowsAcceptValue:
    static_value_map -> graph -> dynamic_value -> bool where
  ...
  * $\forall$ staticEnv graph env . 
  ...
  where
    $\forall$ staticEnv graph n$_r$ .
      staticFlowsAcceptStack staticEnv graph n$_r$ []
  * $\forall$ n$_r$ t graph staticEnv graph env stack n env .
      if 
      ...
      then 
        staticFlowsAcceptStack staticEnv graph n$_r$ ((Ctn n t env) # stack)
...
\begin{lstlisting}[language=logic, mathescape]
  ...
  * $\forall$ atom env .
  ...
  predicate staticEvalValue:
    static_value_map -> static_value_map -> dynamic_value -> bool where
  ...
  * $\forall$ staticEnv staticComm env n$_1$ n$_2$ .
      if
        staticEvalEnv staticEnv staticComm env
      then
        staticEvalValue staticEnv staticComm
  ...
  predicate staticEvalEnv:
    static_value_map -> static_value_map -> env -> bool where 
  ...
  predicate staticEvalStack of
    ...
    static_value set -> stack -> bool where 
  ...
  * $\forall$ staticVals staticEnv staticComm . 
  ...
  predicate staticEvalPool of
    static_value_map -> static_value_map -> pool -> bool where
...
\begin{lstlisting}[language=logic, mathescape]
  lemma staticFlowsAcceptPoolPreserved:
    $\forall$ t$_0$ pool comm staticEnv staticComm graph .
      if
        star dynamicEval [[] -> (Stt t$_0$ [->] [])] {} pool comm, 
        staticEval staticEnv staticComm t$_0$,
...
\begin{lstlisting}[language=logic, mathescape]
  lemma sendChanStaticEvalSound:
    $\forall$ t$_0$ pool comm staticEnv staticComm path
  ...
  lemma staticEvalSound:
    $\forall$ t$_0$ pool comm staticEnv staticComm path t env stack n v .
      if
        staticEval staticEnv staticComm t$_0$, 
        star dynamicEval [[] -> (Stt t$_0$ [->] [])] {} pool comm,
        pool path = Some (Stt t env stack), 
  ...
  lemma staticReachableSound:
    $\forall$ t$_0$ pool comm staticEnv staticComm path t env stack .
      if
        star dynamicEval [[] -> (Stt t$_0$ [->] [])] {} pool comm,
        pool path = Some (Stt t env stack)
      then
...
\begin{lstlisting}[language=logic, mathescape]
  predicate staticReachableForward: term -> term -> bool where
    $\forall$ t$_0$ .
      staticReachableForward t$_0$ t$_0$
  * $\forall$ t$_0$ n t$_c$ t' .
      if 
        staticReachableForward t$_0$ (Bind n (Spwn t$_c$) t')
      then
        staticReachableForward t$_0$ t$_c$
  * $\forall$ t$_0$ n n$_s$ n$_l$ t$_l$ n$_r$ t$_r$ t' .
      if
        staticReachableForward t$_0$ (Bind n (Case n$_s$ n$_l$ t$_l$ n$_r$ t$_r$) t')
      then
        staticReachableForward t$_0$ t$_l$
  * $\forall$ t$_0$ n n$_s$ n$_l$ t$_l$ n$_r$ t$_r$ t' .
      if
        staticReachableForward t$_0$ (Bind n (Case n$_s$ n$_l$ t$_l$ n$_r$ t$_r$) t')
      then
        staticReachableForward t$_0$ t$_r$
  * $\forall$ t$_0$ n n$_f$ n$_p$ t$_b$ t' .
      if
  ...
  * $\forall$ t$_0$ n n$_f$ n$_p$ t$_b$ t' .
  ...
  predicate staticReachableAtom: term -> atom -> bool where
    $\forall$ t$_0$ n$_c$ n$_m$ .
      staticReachableAtom t$_0$ (SendEvt n$_c$ n$_m$)
  * $\forall$ t$_0$ n$_c$ .
      staticReachableAtom t$_0$ (RecvEvt n$_c$)
  * $\forall$ t$_0$ n$_1$ n$_2$ .
      staticReachableAtom t$_0$ (Pair n$_1$ n$_2$)
  * $\forall$ t$_0$ n$_l$ .
      staticReachableAtom t$_0$ (Lft n$_l$)
  * $\forall$ t$_0$ n$_r$
      staticReachableAtom t$_0$ (Rht n$_r$)
  * $\forall$ t$_0$ t$_b$ n$_f$ n$_p$ t$_b$ . 
      if
        staticReachableForward t$_0$ t$_b$ 
      then
        staticReachableAtom t$_0$ (Fun n$_f$ n$_p$ t$_b$)

  predicate staticReachableVal: term -> dynamic_value -> bool where
    $\forall$ t$_0$ .
      staticReachableValue t$_0$ VUnt
  * $\forall$ t$_0$ c .
      staticReachableValue t$_0$ (VChn c)
  * $\forall$ t$_0$ t env .
      if
        staticReachableAtom t$_0$ t, 
        staticReachableEnv t$_0$ env
      then
        staticReachableValue t$_0$ (VAtm t env)

  predicate staticReachableEnv: term -> env -> bool where
    $\forall$ t$_0$ env
      if
        $\forall$ n v . if env n = Some v then
            staticReachableValue t$_0$ v
      then
        staticReachableEnv t$_0$ env

  predicate staticReachableStack: term -> stack -> bool where
    $\forall$ t$_0$ .
      staticReachableStack t$_0$ [])
  * $\forall$ t$_0$ t$_k$ env$_k$ stack' .
      if
        staticReachableForward t$_0$ t$_k$, 
        staticReachableEnv t$_0$ env$_k$,
        staticReachableStack t$_0$ stack' 
      then
        staticReachableStack t$_0$ ((Ctn n$_k$ t$_k$ env$_k$) # stack')
