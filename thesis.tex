...
locale semantics_sound =
  assumes
    exp_always_not_static_bound_sound : "
      ρ' x = Some ω %$\Longrightarrow$%
      (𝒱, 𝒞) static_eval e %$\Longrightarrow$%
      ([[] %$\mapsto$% ⟨e; empty; []⟩], H) star concur_step (trpl', H') %$\Longrightarrow$%
      trpl' pi = Some (⟨e'; ρ'; κ'⟩) %$\Longrightarrow$%
      {|ω|} %$\subseteq$% 𝒱 x" and

    exp_always_exp_not_static_reachable_sound: "
      ([[] %$\mapsto$% ⟨e0;(%$\lambda$% _ . None);[]⟩], {}) star concur_step (trpl', H') %$\Longrightarrow$%
      trpl' pi' = Some (⟨e';ρ';κ'⟩) %$\Longrightarrow$%
...
locale communication_sound =
  ...
  assumes 
    ...
    static_fan_in_sound:
      ...
      (V, C) static_eval e %$\Longrightarrow$%
      star concur_step ([[] %$\mapsto$% ⟨e;(%$\lambda$% _ . None);[]⟩], {}) (trpl', H') %$\Longrightarrow$%
...
\begin{lstlisting}[style=codestyle1, escapechar=\%]
  ...
  let_Case:
      {
        (NLet x, ECall, top_node_label el),
        (NLet x, ECall, top_node_label er),
        (NResult (⌊el⌋), EReturn x, top_node_label e),
        (NResult (⌊er⌋), EReturn x, top_node_label e)} %$\subseteq$% F %$\Longrightarrow$%
  ...
  let_App:
      (%$\forall$% f' xp eb . ^Abs f' xp eb ∈ V f %$\longrightarrow$%
        {(NLet x, ECall, top_node_label eb),
          (NResult (⌊eb⌋), EReturn x, top_node_label e)} %$\subseteq$% F) %$\Longrightarrow$%
      static_traversable V F static_recv_site e %$\Longrightarrow$%
...
where
  ...
  Send_Evt: "
    ⟦
      ^Send_Evt xsc xm ∈ V x;
      static_built_on_chan V Ln xc xsc ∨ static_built_on_chan V Ln xc xm 
    ⟧ %$\Longrightarrow$% 
    static_built_on_chan V Ln xc x
  " |
  Recv_Evt: "
    ⟦
      ^Recv_Evt xrc ∈ V x;
      static_built_on_chan V Ln xc xrc
    ⟧ %$\Longrightarrow$% 
    static_built_on_chan V Ln xc x
  " |
  Pair: "
    ⟦
      ^(Pair x1 x2) ∈ V x;
      static_built_on_chan V Ln xc x1 ∨ static_built_on_chan V Ln xc x2
    ⟧ %$\Longrightarrow$% 
    static_built_on_chan V Ln xc x
  " |
  Left: "
    ⟦
      ^(Left xa) ∈ V x;
      static_built_on_chan V Ln xc xa
    ⟧ %$\Longrightarrow$% 
    static_built_on_chan V Ln xc x
  " |
  Right: "
  ...
  " |
  Abs: "
    ^Abs f xp eb ∈ V x %$\Longrightarrow$% 
    ¬ Set.is_empty (Ln (nodeLabel eb) - {xp}) %$\Longrightarrow$%
    static_built_on_chan V Ln xc x
  " 
  \end{lstlisting}
...
inductive static_live_chan :: "abstract_env %$\Rightarrow$% node_map %$\Rightarrow$% node_map %$\Rightarrow$% var %$\Rightarrow$% exp %$\Rightarrow$% bool" where
  Result: "
    ⟦
      chan_set V Ln xc y = Ln (NResult y)
    ⟧ %$\Longrightarrow$%
    static_live_chan V Ln Lx xc (RESULT y)
  " |
  let_Unit: "
    ⟦
      ...
      Lx (NLet x) = Ln (NLet x)
    ⟧ %$\Longrightarrow$%
    static_live_chan V Ln Lx xc (LET x = ⦇⦈ in e)
  " |
  let_Chan: "
    ⟦
      static_live_chan V Ln Lx xc e;
    ...
    ⟧ %$\Longrightarrow$%
    static_live_chan V Ln Lx xc (LET x = CHAN ⦇⦈ in e)
  " |
  let_Send_Evt: "
    ⟦
      static_live_chan V Ln Lx xc e;
      Ln (nodeLabel e) = Lx (NLet x);
      (Lx (NLet x) - {x}) ∪ chan_set V Ln xc xsc ∪ chan_set V Ln xc xm = Ln (NLet x)
    ⟧ %$\Longrightarrow$%
    static_live_chan V Ln Lx xc (LET x = SEND EVT xsc xm in e)
  " |
  let_Recv_Evt: "
    ⟦
      static_live_chan V Ln Lx xc e;
      Ln (nodeLabel e) = Lx (NLet x);
      (Lx (NLet x) - {x}) ∪ chan_set V Ln xc xrc = Ln (NLet x)
    ⟧ %$\Longrightarrow$%
    static_live_chan V Ln Lx xc (LET x = RECV EVT xrc in e)
  " |
  let_Pair: "
    ⟦
      static_live_chan V Ln Lx xc e;
      Ln (nodeLabel e) = Lx (NLet x);
      (Lx (NLet x) - {x}) ∪  chan_set V Ln xc x1 ∪ chan_set V Ln xc x2 = Ln (NLet x)
    ⟧ %$\Longrightarrow$%
    static_live_chan V Ln Lx xc (LET x = ⦇x1, x2⦈ in e)
  " |
  let_Left: "
    ⟦
      static_live_chan V Ln Lx xc e;
      Ln (nodeLabel e) = Lx (NLet x);
      (Lx (NLet x) - {x}) ∪ chan_set V Ln xc xa = Ln (NLet x)
    ⟧ %$\Longrightarrow$%
    static_live_chan V Ln Lx xc (LET x = LEFT xa in e)
  " |
  let_Right: "
    ⟦
      static_live_chan V Ln Lx xc e;
      ...
      (Lx (NLet x) - {x}) ∪ chan_set V Ln xc xa = Ln (NLet x)
    ⟧ %$\Longrightarrow$%
    static_live_chan V Ln Lx xc (LET x = RIGHT xa in e)
  " |
  let_Abs: "
    ⟦
      static_live_chan V Ln Lx xc e;
      Ln (nodeLabel e) = Lx (NLet x);
      static_live_chan V Ln Lx xc eb;
      (Lx (NLet x) - {x}) ∪ (Ln (nodeLabel eb) - {xp}) = Ln (NLet x)
    ⟧ %$\Longrightarrow$%
    static_live_chan V Ln Lx xc (LET x = FN f xp . eb  in e)
  " |
  let_Spawn: "
    ⟦
      static_live_chan V Ln Lx xc e;
      static_live_chan V Ln Lx xc ec;
      Ln (nodeLabel e) ∪ Ln (nodeLabel ec) = Lx (NLet x);
      (Lx (NLet x) - {x}) = Ln (NLet x)
    ⟧ %$\Longrightarrow$%
    static_live_chan V Ln Lx xc (LET x = SPAWN ec in e)
  " |
  let_Sync: "
    ⟦
      static_live_chan V Ln Lx xc e;
      Ln (nodeLabel e) = Lx (NLet x);
      (Lx (NLet x) - {x}) ∪ chan_set V Ln xc xe = Ln (NLet x)
    ⟧ %$\Longrightarrow$%
    static_live_chan V Ln Lx xc (LET x = SYNC xe in e)
  " |
  let_Fst: "
    ⟦
      static_live_chan V Ln Lx xc e;
      ...
      (Lx (NLet x) - {x}) ∪ chan_set V Ln xc xa = Ln (NLet x)
    ⟧ %$\Longrightarrow$%
    static_live_chan V Ln Lx xc (LET x = FST xa in e)
  " |
  let_Snd: "
    ⟦
      static_live_chan V Ln Lx xc e;
      ...
      (Lx (NLet x) - {x}) ∪ chan_set V Ln xc xa = Ln (NLet x)
    ⟧ %$\Longrightarrow$%
    static_live_chan V Ln Lx xc (LET x = SND xa in e)
  " |
  let_Case: "
    ⟦
      static_live_chan V Ln Lx xc e;
      Ln (nodeLabel e) = Lx (NLet x);
      static_live_chan V Ln Lx xc el;
      static_live_chan V Ln Lx xc er;
      (Lx (NLet x) - {x}) ∪ chan_set V Ln xc xs ∪ 
         (Ln (nodeLabel el) - {xl}) ∪ (Ln (nodeLabel er) - {xr}) = Ln (NLet x)
    ⟧ %$\Longrightarrow$%
    static_live_chan V Ln Lx xc (LET x = CASE xs LEFT xl |> el RIGHT xr |> er in e)
  " |
  let_App: "
    ⟦
      static_live_chan V Ln Lx xc e;
      Ln (nodeLabel e) = Lx (NLet x);
      (Lx (NLet x) - {x}) ∪ chan_set V Ln xc f ∪ chan_set V Ln xc xa = Ln (NLet x)
    ⟧ %$\Longrightarrow$%
    static_live_chan V Ln Lx xc (LET x = APP f xa in e)
  "
...
\begin{lstlisting}[style=codestyle1, escapechar=\%]
  ...
  Next: "
    (l, ENxt, l') ∈ F %$\Longrightarrow$%
    ¬ Set.is_empty (Lx l) %$\Longrightarrow$%
    ¬ Set.is_empty (Ln l') %$\Longrightarrow$%
    static_live_traversable F Ln Lx (l, ENxt, l')
  " |
  Spawn: "
    (l, ESpwn, l') ∈ F %$\Longrightarrow$%
    ¬ Set.is_empty (Lx l) %$\Longrightarrow$%
    ¬ Set.is_empty (Ln l') %$\Longrightarrow$%
    static_live_traversable F Ln Lx (l, ESpwn, l')
  " |
  Call_Live_Outer: "
    (l, ECall, l') ∈ F %$\Longrightarrow$%
    ¬ Set.is_empty (Lx l) %$\Longrightarrow$%
  ...
  " |
  Return: "
    (l, ERtn x, l') ∈ F %$\Longrightarrow$%
    ¬ Set.is_empty (Ln l') %$\Longrightarrow$%
    static_live_traversable F Ln Lx (l, ERtn x, l')
  " |
  Send: "
    ((NLet xSend), ESend xE, (NLet xRecv)) ∈ F %$\Longrightarrow$%
...
inductive static_live_traceable :: "abstract_env %$\Rightarrow$% flow_set %$\Rightarrow$% node_map %$\Rightarrow$% node_map %$\Rightarrow$% node_label %$\Rightarrow$% (node_label %$\Rightarrow$% bool) %$\Rightarrow$% abstract_path %$\Rightarrow$% bool" where
  ...
  Pre_Return: "
    static_live_traceable V F Ln Lx (NResult y) isEnd ((NResult y, ERtn x) # post) %$\Longrightarrow$%
    static_traceable  F (NResult y) pre %$\Longrightarrow$%
    ¬ static_balanced (pre @ [(NResult y, ERtn x)]) %$\Longrightarrow$%
    ¬ Set.is_empty (Lx (NLet x)) %$\Longrightarrow$%
    path = pre @ (NResult y, ERtn x) # post %$\Longrightarrow$%
...
inductive static_inclusive :: "abstract_path %$\Rightarrow$% abstract_path %$\Rightarrow$% bool" (infix "≍" 55) where
  Prefix1: "
    prefix pi1 pi2 %$\Longrightarrow$%
    pi1 ≍ pi2
  " |
  ...
  " |
  Spawn1: "
    pi @ (NLet x, ESpwn) # pi1 ≍ pi @ (NLet x, ENxt) # pi2
  " |
  Spawn2: "
    pi @ (NLet x, ENxt) # pi1 ≍ pi @ (NLet x, ESpwn) # pi2
  " |
  Send1: "
    pi @ (NLet x, ESend xE) # pi1 ≍ pi @ (NLet x, ENxt) # pi2
  " |
  Send2: "
    pi @ (NLet x, ENxt) # pi1 ≍ pi @ (NLet x, ESend xE) # pi2
    "
...
\begin{lstlisting}[style=codestyle1, escapechar=\%]
  ...
  inductive 
  dynamic_built_on_chan_var :: "(var ⇀ val) %$\Rightarrow$% chan %$\Rightarrow$% var %$\Rightarrow$% bool" and
  dynamic_built_on_chan_prim :: "(var ⇀ val) %$\Rightarrow$% chan %$\Rightarrow$% prim %$\Rightarrow$% bool" and
  dynamic_built_on_chan_bindee :: "(var ⇀ val) %$\Rightarrow$% chan %$\Rightarrow$% bind %$\Rightarrow$% bool" and
  dynamic_built_on_chan_exp :: "(var ⇀ val) %$\Rightarrow$% chan %$\Rightarrow$% exp %$\Rightarrow$% bool" 
where
  Chan: "
    ρ x = Some (VChan c) %$\Longrightarrow$%
    dynamic_built_on_chan_var ρ c x
  " |
  Closure: "
    dynamic_built_on_chan_prim ρ' c p %$\Longrightarrow$%
    ρ x = Some (VClosure p ρ') %$\Longrightarrow$%
    dynamic_built_on_chan_var ρ c x
  " |


  Send_Evt: "
    dynamic_built_on_chan_var ρ c xSC ∨ dynamic_built_on_chan_var ρ c xM %$\Longrightarrow$%
    dynamic_built_on_chan_prim ρ c (Send_Evt xSC xM)
  " |
  Recv_Evt: "
    dynamic_built_on_chan_var ρ c xRC %$\Longrightarrow$%
    dynamic_built_on_chan_prim ρ c (Recv_Evt xRC)
  " |
  Pair: "
    dynamic_built_on_chan_var ρ c x1 ∨ dynamic_built_on_chan ρ c x2 %$\Longrightarrow$%
    dynamic_built_on_chan_prim ρ c (Pair x1 x2)
  " |
  Left: "
    dynamic_built_on_chan_var ρ c xSum %$\Longrightarrow$%
  ...
  " |
  Abs: "
    dynamic_built_on_chan_exp ρ' c e %$\Longrightarrow$%
  ...
  " |
  Spawn: "
    dynamic_built_on_chan_exp ρ c eCh %$\Longrightarrow$%
    dynamic_built_on_chan_bindee ρ c (SPAWN eCh)
  " |
  Sync: "
    dynamic_built_on_chan_var ρ c xY %$\Longrightarrow$%
    dynamic_built_on_chan_bindee ρ c (SYNC xY)
  " |
  Fst: "
    dynamic_built_on_chan_var ρ c xP %$\Longrightarrow$%
  ...
  Case: "
    ...
    dynamic_built_on_chan_exp ρ c eL ∨ dynamic_built_on_chan_exp ρ c eR %$\Longrightarrow$%
    dynamic_built_on_chan_bindee ρ c (CASE xS LEFT xL |> eL RIGHT xR |> eR)
  " |
  App: "
    dynamic_built_on_chan_var ρ c f ∨
    dynamic_built_on_chan_var ρ c xA %$\Longrightarrow$%
    dynamic_built_on_chan_bindee ρ c (APP f xA)
  " |

  Result: "
    dynamic_built_on_chan_var ρ c x %$\Longrightarrow$%
    dynamic_built_on_chan_exp ρ c (RESULT x)
  " |
  Let: "
    dynamic_built_on_chan_bindee ρ c b ∨ dynamic_built_on_chan_exp ρ c e %$\Longrightarrow$%
...
\begin{lstlisting}[style=codestyle1, escapechar=\%]
  ...
  Return: "
    ...
    paths_correspond (pi @ [LReturn y]) (path @ (NLet x, ECall) # path' @ [(NResult y, ERtn x)])
  " 
...
inductive paths_correspond_mod_chan :: 
  ...
  Unordered: "
    ...
    ¬ (prefix pathx path) %$\Longrightarrow$%
    ¬ (prefix path pathx) %$\Longrightarrow$%
    paths_correspond_mod_chan (trpl, H) c pi path
  " |
  Chan: "
    paths_correspond ((LNext xC) # piSuff) path %$\Longrightarrow$%
    trpl (piC @ (LNext xC) # piSuff) ≠ None %$\Longrightarrow$%
    paths_correspond_mod_chan (trpl, H) (Ch piC xC) (piC @ (LNext xC) # piSuff) path
  " |
  Sync: "
    paths_correspond piSuffix pathSuffix %$\Longrightarrow$%
    trpl (piR @ (LNext xR) # piSuffix) ≠ None %$\Longrightarrow$%
    dynamic_built_on_chan_var ρRY c xR %$\Longrightarrow$%
    trpl piS = Some (⟨LET xS = SYNC xSE in eSY;ρSY;κSY⟩) %$\Longrightarrow$%
    trpl piR = Some (⟨LET xR = SYNC xRE in eRY;ρRY;κRY⟩) %$\Longrightarrow$%
    {(piS, c, piR)} %$\subseteq$% H %$\Longrightarrow$%
    paths_correspond_mod_chan (trpl, H) c piS pathPre %$\Longrightarrow$%
    paths_correspond_mod_chan (trpl, H) c (piR @ (LNext xR) # piSuffix) (pathPre @ (NLet xS, ESend xSE) # (NLet xR, ENxt) # pathSuffix)
  " 
...
lemma not_static_inclusive_sound_base: "
  E0 = [[] %$\mapsto$% ⟨e;(%$\lambda$% _ . None);[]⟩] %$\Longrightarrow$%
  E0 pi1 ≠ None %$\Longrightarrow$%
  E0 pi2 ≠ None %$\Longrightarrow$%
  paths_correspond_mod_chan (E0, {}) (Ch pi xC) pi1 path1 %$\Longrightarrow$% 
  paths_correspond_mod_chan (E0, {}) (Ch pi xC) pi2 path2 %$\Longrightarrow$%
  path1 ≍ path2
"
proof -
  \end{lstlisting}
...
\begin{lstlisting}[style=codestyle1, escapechar=\%]
  ...
  paths_correspond_mod_chan (trpl', H') (Ch pi xC) pi1 path1 %$\Longrightarrow$%
  paths_correspond_mod_chan (trpl', H') (Ch pi xC) pi2 path2 %$\Longrightarrow$%
  ([[] %$\mapsto$% ⟨e;(%$\lambda$% _ . None);[]⟩], {}) star concur_step (trpl', H') %$\Longrightarrow$% 
  trpl' pi1 ≠ None %$\Longrightarrow$% 
  trpl' pi2 ≠ None   %$\Longrightarrow$% 
  pi1 = pi2
"
sorry
  ...
  lemma not_static_traceable_sound: "
  trpl' pi = Some (⟨LET x = b in en;ρ;κ⟩) %$\Longrightarrow$%
  ρ z ≠ None %$\Longrightarrow$%
  dynamic_built_on_chan_var ρ (Ch piC xC) z %$\Longrightarrow$%
  ([[] %$\mapsto$% ⟨e;(%$\lambda$% _ . None);[]⟩], {}) star concur_step (trpl', H') %$\Longrightarrow$% 
  (V, C) static_eval e %$\Longrightarrow$%
  static_live_chan V Ln Lx xC e %$\Longrightarrow$%
  static_traversable V F (static_recv_node_label V e) e %$\Longrightarrow$%
  isEnd (NLet x) %$\Longrightarrow$%
  ∃ path . 
    paths_correspond_mod_chan (trpl', H') (Ch piC xC) pi path ∧
...
lemma send_not_static_traceable_sound: "
  is_send_path trpl' (Ch piC xC) piSync %$\Longrightarrow$%
  star concur_step ([[] %$\mapsto$% (Stt e (%$\lambda$% _ . None) [])], {}) (trpl', H') %$\Longrightarrow$% 
  (V, C) static_eval e %$\Longrightarrow$%
  static_live_chan V Ln Lx xC e %$\Longrightarrow$%
  static_traversable V F (static_recv_node_label V e) e %$\Longrightarrow$%
  ∃ pathSync .
    (paths_correspond_mod_chan (trpl', H') (Ch piC xC) piSync pathSync) ∧ 
