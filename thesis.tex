...
The static semantics describes an estimation of intermediate static values and subprograms
...
\begin{lstlisting}[language=logic, mathescape]
  ...
  (\forall n$_s$ static_env n static_comm p' .
    if
      (SAtm(Rght n$_s$)) \in static_env x, 
  ...
  (\forall n$_f$ n$_p$ p$_b$ static_env static_comm n p' .
    if
      (SAtm (Fun n$_f$ n$_p$ p$_b$)) \in static_env f, 
  ...
  (\forall n$_f$ n$_p$ p$_b$ static_env static_comm n p' .
    if
      ...
      static_eval static_env static_comm p$_c$, 
      static_eval static_env static_comm p'
    then
      static_eval static_env static_comm (Bind n (Spwn p$_c$) p')
  ),
  ...
  (\forall static_env n$_p$ n static_comm p' . 
    if
      (\forall n1 n2 . if (SAtm (Pair n1 n2)) \in static_env n$_p$ then
  ...
  (\forall static_env n$_s$ n$_l$ p$_l$ n static_comm n$_r$ p$_r$ p' . 
    if
      ...
      (\forall n$_c$ . if (SAtm (Rght n$_c$)) \in static_env n$_s$ then 
...
to mean
\lstinline[language=logic]|\lambda n . if n = (Nm "r1") then {SAtm (Rght (Nm "u1"))} else ... else {}|.
...
\begin{lstlisting}[language=logic, mathescape]
  predicate static_built_on_chan of
    ...
    (\forall n$_a$ static_env n entr n$_c$ .
      if
        (SAtm (Rght n$_a$)) \in static_env x,
        static_built_on_chan static_env entr n$_c$ n$_a$
      then 
        static_built_on_chan static_env entr n$_c$ x),
