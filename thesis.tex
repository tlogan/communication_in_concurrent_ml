...
With the the definitions of star_left, static_reachable_left and its generations,
lemma not_static_reachable_sound follows via induction on star_left.
...
lemma static_reachable_left_implies_static_reachable follows from induction on statc_reachable_left and
static_reachable_trans, which follows from induction on static_reachable.
