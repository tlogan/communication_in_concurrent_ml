...
it is decidable if a given finite set of flows holds. The static paths are from the chaining of flows.
...
if the classification holds statically, then it must hold dynamically.
