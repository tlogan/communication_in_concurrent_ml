...
reachability follows from induction on the leftward static reachability and the transitivity of static
...
The sub portion of the program is represented by a static program containing all
