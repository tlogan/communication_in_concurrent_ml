...
Control paths are simply sequences of let bound names. A modification of the example Server
...
the program, incrementally adding more static values for each name in the program.
...
\begin{lstlisting}[language=logic, escapechar=\%]
  fun server_static_env of name -> static_vale set:
    (%$\forall$% x . server_static_env x =
      ...
      if x = (Nm "r1") then {} else
      if x = (Nm "l1") then {} else
      if x = (Nm "l2") then {} else
      if x = (Nm "lp") then {} else
      if x = (Nm "lp'") then {} else
      if x = (Nm "x1'") then {} else
      if x = (Nm "z1") then {} else
      if x = (Nm "y1") then {} else
      if x = (Nm "z2") then {} else
      if x = (Nm "y2") then {} else
      if x = (Nm "u2") then {} else
      if x = (Nm "u3") then {} else
      if x = (Nm "mksr") then {} else
      if x = (Nm "x2") then {} else
      if x = (Nm "k1") then {} else
      if x = (Nm "z4") then {} else
