...
induction should be from the end to the begininng of the program.  the predicate static_reachable follows
from static_reachable_left, but it enables unraveling the reachable
