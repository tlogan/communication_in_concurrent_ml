...
The lemma for soundness of static one-shot classification states that if a static channel is
...
from running the program. The lemma for soundness of static fan-out classification states that if
...
over any pool that results from running the program.  The lemmas for soundness of many-to-one
