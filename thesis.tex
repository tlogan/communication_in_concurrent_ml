...
\begin{lstlisting}[style=codestyle1, escapechar=\%]
  ...
  let_Case:
      {
        (NLet x, ECall, top_node_label el),
        (NLet x, ECall, top_node_label er),
        (NRslt (⌊el⌋), EReturn x, top_node_label e),
        (NRslt (⌊er⌋), EReturn x, top_node_label e)} %$\subseteq$% F %$\Longrightarrow$%
  ...
  let_App:
      (%$\forall$% f' xp eb . ^Abs f' xp eb %$\in$% V f %$\longrightarrow$%
        {(NLet x, ECall, top_node_label eb),
          (NRslt (⌊eb⌋), EReturn x, top_node_label e)} %$\subseteq$% F) %$\Longrightarrow$%
      static_traversable V F static_recv_site e %$\Longrightarrow$%
...
where
  ...
  Send_Evt: 
      APrim (Send_Evt xsc xm) %$\in$% V x %$\Longrightarrow$% 
      static_built_on_chan V Ln xc xsc ∨ static_built_on_chan V Ln xc xm %$\Longrightarrow$% 
      static_built_on_chan V Ln xc x |
  Recv_Evt:
    APrim (Recv_Evt xrc) %$\in$% V x %$\Longrightarrow$% 
    static_built_on_chan V Ln xc xrc %$\Longrightarrow$% 
    static_built_on_chan V Ln xc x |
  Pair:
      APrim (Pair x1 x2) %$\in$% V x %$\Longrightarrow$%
      static_built_on_chan V Ln xc x1 ∨ static_built_on_chan V Ln xc x2 %$\Longrightarrow$% 
      static_built_on_chan V Ln xc x |
  Left:
...
\begin{lstlisting}[style=codestyle1, escapechar=\%]
  ...
  Let_Spawn:
      ...
      Ln (top_node_label e) %$\union$% Ln (top_node_label ec) = Lx (NLet x) %$\Longrightarrow$%
      (Lx (NLet x) - {x}) = Ln (NLet x) %$\Longrightarrow$%
      static_live_chan V Ln Lx xc (Let x (Spwn ec) e) |
  Let_Sync:
      static_live_chan V Ln Lx xc e %$\Longrightarrow$%
      Ln (top_node_label e) = Lx (NLet x) %$\Longrightarrow$%
      (Lx (NLet x) - {x}) %$\union$% chan_set V Ln xc xe = Ln (NLet x) %$\Longrightarrow$%
  ...
  Let_Case:
      ...
      (Lx (NLet x) - {x}) %$\union$% chan_set V Ln xc xs %$\union$% 
      (Ln (top_node_label el) - {xl}) %$\union$%
...
where
  ...
  Result: "
    ...
    dynamic_built_on_chan_exp ρ c (Rslt x)
  " |
  Let: "
...
\begin{lstlisting}[style=codestyle1, escapechar=\%]
  ...
  Return: "
    ...
    paths_correspond (pi @ [LReturn y]) (path @ (NLet x, ECall) # path' @ [(NRslt y, ERtn x)])
  " 
...
inductive paths_correspond_mod_chan :: 
  ...
  Unordered: "
    ...
    %$\not$% (prefix pathx path) %$\Longrightarrow$%
    %$\not$% (prefix path pathx) %$\Longrightarrow$%
