...
\begin{lstlisting}[style=codestyle1, escapechar=\%]
inductive is_super_exp :: "exp ⇒ exp ⇒ bool"  where
  Refl : "
    is_super_exp e e
  " | 
  Let_Spawn_Child: "
    is_super_exp e⇩c e ⟹
    is_super_exp (LET x = SPAWN e⇩c in e⇩n) e
  " |
  Let_Case_Left: "
    is_super_exp e⇩l e ⟹
    is_super_exp (LET x = CASE x⇩s LEFT x⇩l |> e⇩l RIGHT x⇩r |> e⇩r in e⇩n) e
  " |
  Let_Case_Right: "
    is_super_exp e⇩r e ⟹
    is_super_exp (LET x = CASE x⇩s LEFT x⇩l |> e⇩l RIGHT x⇩r |> e⇩r in e⇩n) e
  ...
  Let_Abs_Body: "
    is_super_exp e⇩b e ⟹
    is_super_exp (LET x = FN f x⇩p . e⇩b in e⇩n) e
  " | 
  Let: "
    is_super_exp e⇩n e ⟹
    is_super_exp (LET x = b in e⇩n) e
  "

inductive is_super_exp_left :: "exp ⇒ exp ⇒ bool"  where
  Refl : "
    is_super_exp_left e0 e0
  " | 
  Let_Spawn_Child: "
    is_super_exp_left e0 (LET x = SPAWN e⇩c in e⇩n)⟹
    is_super_exp_left e0 e⇩c
  " |
  Let_Case_Left: "
    is_super_exp_left e0 (LET x = CASE x⇩s LEFT x⇩l |> e⇩l RIGHT x⇩r |> e⇩r in e⇩n) ⟹
    is_super_exp_left e0 e⇩l
  " |
  Let_Case_Right: "
    is_super_exp_left e0 (LET x = CASE x⇩s LEFT x⇩l |> e⇩l RIGHT x⇩r |> e⇩r in e⇩n) ⟹
    is_super_exp_left e0 e⇩r
  " |
  Let_Abs_Body: "
    is_super_exp_left e0 (LET x = FN f x⇩p . e⇩b in e⇩n) ⟹
    is_super_exp_left e0 e⇩b
  " | 
  Let: "
    is_super_exp_left e0 (LET x = b in e⇩n) ⟹
    is_super_exp_left e0 e⇩n
  "

    inductive is_super_exp_over_prim :: "exp ⇒ prim ⇒ bool" where
  Send_Evt: "
  ...
  Abs: "
    is_super_exp_left e0 e⇩b ⟹
    is_super_exp_over_prim e0 (Abs f⇩p x⇩p e⇩b)
  " 

inductive 
  is_super_exp_over_env :: "exp ⇒ env ⇒ bool" and
  is_super_exp_over_val :: "exp ⇒ val ⇒ bool"
where
  VUnit: "
  ...
  " |
  VClosure: "
    is_super_exp_over_prim e0 p ⟹
    is_super_exp_over_env e0 ρ' ⟹
    is_super_exp_over_val e0 (VClosure p ρ')
  " |

  Intro: "
    ∀ x ω . ρ x = Some ω ⟶ is_super_exp_over_val e0 ω ⟹
    is_super_exp_over_env e0 ρ
  "

inductive is_super_exp_over_stack :: "exp ⇒ cont list ⇒ bool" where
  Empty: "
    is_super_exp_over_stack e0 []
  " |
  Nonempty: "
    is_super_exp_left e0 e⇩κ ⟹
    is_super_exp_over_env e0 ρ⇩κ ⟹
    is_super_exp_over_stack e0 κ ⟹
    is_super_exp_over_stack e0 (⟨x⇩κ,e⇩κ,ρ⇩κ⟩ # κ)
  "

inductive is_super_exp_over_state :: "exp ⇒ state ⇒ bool" where
  Intro: "
    is_super_exp_left e0 e ⟹
    is_super_exp_over_env e0 ρ ⟹
    is_super_exp_over_stack e0 κ ⟹
    is_super_exp_over_state e0 (⟨e;ρ;κ⟩)
  "
