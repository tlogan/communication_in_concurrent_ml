...
deduction of abstract program transitions.  As with the generalized version of
...
static_eval_env :: "abstract_env × abstract_env ⇒ env ⇒ bool" (infix "⊨⇩ρ" 55) 
  Intro: " 
    ∀ x ω . ρ x = Some ω ⟶ {|ω|} ⊆ 𝒱 x ∧ (𝒱, 𝒞) ⊨⇩ω ω ⟹
    (𝒱, 𝒞) ⊨⇩ρ ρ
  "


inductive static_eval_stack :: "abstract_env × abstract_env ⇒ abstract_value set ⇒ contin list ⇒ bool" ("_ ⊨⇩κ _ ⇛ _" [56,0,56]55) where
  Empty: "(𝒱, 𝒞) ⊨⇩κ 𝒲 ⇛ []" |
  Nonempty: "
    ⟦ 
      𝒲 ⊆ 𝒱 x;
...
inductive static_eval_state :: "abstract_env × abstract_env ⇒ state ⇒ bool" (infix "⊨⇩σ" 55)  where
  Intro: "
    ⟦
      (𝒱, 𝒞) ⊨⇩e e;
      (𝒱, 𝒞) ⊨⇩ρ ρ;
...
inductive static_eval_pool :: "abstract_env × abstract_env ⇒ trace_pool ⇒ bool" (infix "⊨⇩ℰ" 55) where
  Intro: "
    (∀ π σ . ℰ π = Some σ ⟶ (𝒱, 𝒞) ⊨⇩σ σ) ⟹ 
    (𝒱, 𝒞) ⊨⇩ℰ ℰ
  "
